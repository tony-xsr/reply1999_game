// Điều phối Nghe & Đoán: Quốc Gia, Số Đếm & Nghề Nghiệp — máy đọc 1 từ hoặc
// câu tiếng Anh ngắn (giọng en-US thật, câu dài đọc chậm hơn), bé chạm đúng
// hình phù hợp trong 4 lựa chọn — lọc được theo chủ đề (quốc gia & quốc kỳ /
// số đếm & thứ tự / môn học / nghề nghiệp mở rộng / dụng cụ & văn phòng) hoặc
// chơi lẫn cả 5 chủ đề ("Tất cả").

import {
  TOPICS, makeGame, currentRound, chooseOption, promptFor, rateFor,
} from './quocgianghenghiep.js';
...
sayInstruction(t('nghedoan7.help', 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về quốc gia, số đếm, môn học hay nghề nghiệp — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.'));
startRound();

// Hook cho e2e test
window.__nghedoan7 = { state, startRound };
