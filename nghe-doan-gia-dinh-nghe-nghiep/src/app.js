// Điều phối Nghe & Đoán: Gia Đình & Nghề Nghiệp — máy đọc 1 từ hoặc câu tiếng Anh
// ngắn (giọng en-US thật, câu dài đọc chậm hơn), bé chạm đúng hình phù hợp trong
// 4 lựa chọn — lọc được theo chủ đề (gia đình & bạn bè / trường học / nghề
// nghiệp / thể thao / thi đấu & hoạt động) hoặc chơi lẫn cả 5 chủ đề ("Tất cả").
...
sayInstruction(t('nghedoan4.help', 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về gia đình, trường học, nghề nghiệp hay thể thao — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.'));
startRound();

// Hook cho e2e test
window.__nghedoan4 = { state, startRound };
