// Điều phối Luyện Thi TOEIC — bản "KHOÁ CẤP ĐỘ" tách riêng từ exam-prep/:
// trước đây exam-prep/ gộp nhiều cấp độ trong CÙNG 1 màn chọn cấp độ, theo
// phản hồi của người dùng "gộp vậy bé rối" nên TOEIC được tách thành mục
// riêng biệt — bấm vào là vào thẳng TOEIC, không phải chọn cấp độ trước.
// TOEIC là track CUỐI CÙNG trong yêu cầu gốc "cambridge ket pet toefl toeic".
//
// Dùng lại NGUYÊN VẸN engine/dữ liệu từ exam-prep/ (cùng Unit/misses.js) —
// chỉ khoá cứng LEVEL_ID = 'toeic' và bỏ hẳn màn chọn cấp độ khỏi luồng UI.
...
const LEVEL_ID = 'toeic';
const LEVEL_LABEL = '💼 TOEIC (800/990)';
...
sayInstruction(t('extoeic.help', 'Đây là Luyện Thi TOEIC! Chọn Học theo Unit để đọc bài học và luyện tập có gợi ý, hoặc chọn Luyện Thi để làm đề trộn ngẫu nhiên có tính giờ giống thi thật. Mỗi câu có 1 câu tiếng Anh thiếu từ, bé chọn đúng từ để điền vào chỗ trống.'));

// Hook cho e2e test
window.__extoeic = { state, startStudyQuiz, startMockTest };
