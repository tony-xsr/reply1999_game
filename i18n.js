...
(function(){
  ...
  const STRINGS = {
    ...
    'tomau.help':               { vi: 'Chạm vào 1 màu ở khay bên dưới, rồi chạm vào vùng trên hình để tô màu đó vào. Tô kín cả chữ hoặc số là xong! Bấm nút cây cọ để đổi sang tô theo số, mỗi vùng có 1 con số ứng với 1 màu.', en: 'Tap a color in the tray below, then tap an area on the picture to fill it in. Color the whole letter or number to finish! Tap the brush button to switch to color-by-number mode.', ja: 'したのパレットからいろをえらんで、えのぶぶんをタップしてぬろう。もじやすうじをぜんぶぬったらおわり！ふででボタンをおすと、ばんごうどおりにぬるモードにかわるよ。', zh: '点击下方调色板选一个颜色，再点击图案区域上色。涂满整个字母或数字就完成了！点击画笔按钮切换到按数字上色模式。', ar: 'انقر لونًا من اللوحة أدناه، ثم انقر منطقة في الصورة لتلوينها. لوّن الحرف أو الرقم بالكامل لتنتهي! انقر زر الفرشاة للتبديل إلى وضع التلوين بالأرقام.' },
    ...
    'tapviet.help':             { vi: 'Nhìn chữ mờ trên bảng, rê ngón tay hoặc chuột theo đúng nét chỉ dẫn. Đi đúng đường thì nét hiện màu, lệch quá thì làm lại nét đó. Có 4 chế độ: Nét cơ bản, chữ cái tiếng Việt, chữ cái tiếng Anh, và viết tên của bé.', en: 'Look at the faint letter on the board, then drag your finger or mouse along the guide stroke. Follow it correctly and the stroke turns colored; stray too far and you redo that stroke. 4 modes: basic strokes, Vietnamese letters, English letters, and writing your own name.', ja: 'ボードのうすいもじをみて、ゆびやマウスでせんをなぞろう。ただしくなぞるといろがつくよ、ずれたらもういちど。4つのモード：きほんのせん、ベトナムごのもじ、えいごのもじ、じぶんのなまえ。', zh: '看板上淡淡的字，用手指或鼠标沿着引导笔画描摹。描对了笔画会变色，偏太多就要重描。4种模式：基本笔画、越南语字母、英语字母、写自己的名字。', ar: 'انظر إلى الحرف الباهت على اللوحة، ثم اسحب إصبعك أو الفأرة على طول الخط الموجّه. اتبعه بشكل صحيح ليتلون، وإذا انحرفت كثيرًا أعد ذلك الخط. 4 أوضاع: خطوط أساسية، حروف فيتنامية، حروف إنجليزية، وكتابة اسمك.' },
    ...
    'hocvui.help.match':        { vi: 'Kéo hoặc chạm thẻ chữ rồi thả đúng vào hình phù hợp — ghép đúng cặp chữ và hình là được điểm!', en: 'Drag or tap a word card and drop it on the matching picture — match the word and picture correctly to score!', ja: 'もじカードをドラッグかタップして、あうえにおとそう。ただしくペアにするととくてん！', zh: '拖动或点击文字卡片，放到对应的图片上——配对正确就得分！', ar: 'اسحب أو انقر بطاقة كلمة وضعها على الصورة المطابقة — طابق بشكل صحيح لتسجل نقاط!' },
    'hocvui.help.count':        { vi: 'Nhìn số lượng đồ vật rồi chạm vào đáp án đúng trong các nút bên dưới.', en: 'Look at how many objects there are, then tap the correct answer among the buttons below.', ja: 'もののかずをみて、したのボタンからただしいこたえをタップしよう。', zh: '看看有多少物品，然后在下面的按钮中点击正确答案。', ar: 'انظر إلى عدد الأشياء ثم انقر الإجابة الصحيحة من الأزرار أدناه.' },
    'hocvui.help.listen':       { vi: 'Bấm nút loa để nghe tên đồ vật, rồi chạm đúng hình được gọi tên trong lưới hình.', en: 'Tap the speaker button to hear the object\'s name, then tap the matching picture in the grid.', ja: 'スピーカーボタンをおしてなまえをきいて、グリッドからただしいえをタップしよう。', zh: '点击喇叭按钮听物品名称，然后在图片网格中点击对应的图片。', ar: 'انقر زر مكبر الصوت لسماع اسم الشيء، ثم انقر الصورة المطابقة في الشبكة.' },
    ...
    'lathinh.help':             { vi: 'Chạm 2 thẻ hình úp để lật lên. Giống nhau thì được điểm và 2 thẻ đó biến mất, khác nhau thì lại úp xuống. Cố nhớ vị trí để ghép được nhiều cặp giống nhau nhất nhé!', en: 'Tap 2 face-down cards to flip them. If they match, you score and both cards disappear; if not, they flip back down. Try to remember where things are to match as many pairs as possible!', ja: '2まいのカードをめくろう。おなじならとくてん、ちがうならまたうらがえるよ。ばしょをおぼえて、たくさんペアをつくろう！', zh: '点击2张背面朝上的卡片翻开。相同就得分且这2张消失，不同就翻回去。记住位置，配对越多越好！', ar: 'انقر بطاقتين مقلوبتين لتقليبهما. إذا تطابقتا تسجل نقطة وتختفيان، وإلا تعودان للخلف. حاول تذكر الأماكن لمطابقة أكبر عدد من الأزواج!' },
    ...
    'ran.help':                 { vi: 'Dùng nút mũi tên hoặc vuốt để dẫn rắn đi ăn mồi — ăn xong rắn dài thêm ra! Đừng để rắn đụng tường hay đụng chính mình nhé. Có 3 chế độ: Cổ điển ăn táo, A tới Z ăn đúng thứ tự chữ cái, 1 tới 9 ăn đúng thứ tự số.', en: 'Use the arrow buttons or swipe to guide the snake to food — eating makes it grow longer! Don’t let it hit the wall or itself. 3 modes: Classic eats apples, A-to-Z eats letters in order, 1-to-9 eats numbers in order.', ja: 'やじるしボタンかスワイプでヘビをうごかしてえさをたべよう！ヘビはたべるとながくなるよ。かべやじぶんにぶつからないでね。3つのモード：クラシックはりんご、A→Zはもじじゅん、1→9はすうじじゅん。', zh: '用方向按钮或滑动引导蛇去吃食物——吃了会变长！别让蛇撞墙或撞到自己。3种模式：经典吃苹果，A到Z按字母顺序吃，1到9按数字顺序吃。', ar: 'استخدم أزرار الأسهم أو السحب لتوجيه الثعبان لأكل الطعام — الأكل يجعله أطول! لا تدعه يصطدم بالجدار أو بنفسه. 3 أوضاع: كلاسيكي يأكل التفاح، A إلى Z بالترتيب الأبجدي، 1 إلى 9 بالترتيب الرقمي.' },
    ...
    'ghephinh.help':            { vi: 'Bức ảnh bị xáo và có 1 ô trống. Chạm vào ô cùng hàng hoặc cùng cột với ô trống để cả dãy trượt theo. Xếp đúng thứ tự các mảnh là xong! Giữ nút con mắt để xem trước hình mẫu.', en: 'The picture is scrambled with 1 empty space. Tap a tile in the same row or column as the empty space to slide the whole row/column. Arrange the pieces in order to finish! Hold the eye button to peek at the finished picture.', ja: 'えがバラバラになって、あきマスが1つあるよ。あきマスとおなじたてよこのれつのマスをタップすると、ぜんぶがスライドするよ。じゅんばんにならべたらクリア！めボタンをおしつづけると、みほんがみえるよ。', zh: '图片被打乱了，有1个空格。点击与空格同行或同列的方块，整行/整列都会滑动。把碎片排列正确就完成了！按住眼睛按钮可以预览完整图片。', ar: 'الصورة مبعثرة وبها مكان فارغ واحد. انقر قطعة في نفس الصف أو العمود مع الفراغ لتنزلق الصفوف/الأعمدة كلها. رتّب القطع بالترتيب الصحيح لتنتهي! اضغط مطولاً على زر العين لمعاينة الصورة الكاملة.' },
    ...
    'caro.help':                { vi: 'Chạm vào ô trống để đánh dấu. Bàn 3 nhân 3 cần 3 ô thẳng hàng, bàn 9 nhân 9 cần 5 ô thẳng hàng là thắng! Có thể chơi với máy hoặc chơi 2 người trên cùng máy.', en: 'Tap an empty square to mark it. The 3x3 board needs 3 in a row, the 9x9 board needs 5 in a row to win! Play against the computer or 2 players on the same device.', ja: 'あいているマスをタップしてマークしよう。3×3は3つ、9×9は5つならぶとかち！コンピューターとも、ふたりでも遊べるよ。', zh: '点击空格做标记。3×3需要连成3个，9×9需要连成5个才能获胜！可以和电脑对战，也可以两人同机对战。', ar: 'انقر خانة فارغة لوضع علامة. لوحة 3×3 تحتاج 3 متتالية، ولوحة 9×9 تحتاج 5 للفوز! العب ضد الحاسوب أو مع لاعب آخر.' },
    ...
    'xepgach.help':             { vi: 'Các khối gạch rơi xuống, dùng nút mũi tên để di chuyển, nút xoay để đổi hướng khối, và nút mũi tên xuống nhanh để thả gấp! Xếp kín một hàng ngang là hàng đó biến mất, được điểm.', en: 'Bricks fall down — use the arrow buttons to move, the rotate button to turn the brick, and the down arrow to drop fast! Fill a row completely to clear it and score.', ja: 'ブロックがおちてくるよ。やじるしボタンでうごかして、回転ボタンでむきをかえて、したのやじるしでさっとおとそう！よこいちれつをうめるとラインがきえてとくてん！', zh: '方块往下掉——用方向按钮移动，用旋转按钮转方向，用下方向键快速落下！填满一整行就会消除得分。', ar: 'تتساقط القطع — استخدم أزرار الأسهم للتحريك، وزر التدوير لتغيير الاتجاه، والسهم للأسفل للإسقاط السريع! املأ صفًا كاملاً لمسحه وتسجيل نقاط.' },
    ...
    'batvit.help':              { vi: 'Vịt sẽ ngoi lên ở các hố, chạm thật nhanh để bắt điểm! Chọn "Đập theo chữ" để chỉ đập đúng con vịt mang chữ cái được yêu cầu.', en: 'Ducks pop up from the holes — tap fast to score! Choose "Whack by letter" to only whack the duck carrying the called-out letter.', ja: 'あなからアヒルがでてくるよ、はやくタップしてね！「文字でたたく」をえらぶと、よばれたもじのアヒルだけたたこう。', zh: '鸭子会从洞里冒出来，快速点击得分！选择"按字母打"只打带指定字母的鸭子。', ar: 'يظهر البط من الحفر — انقر بسرعة لتسجيل نقاط! اختر "حسب الحرف" لضرب البطة التي تحمل الحرف المطلوب فقط.' },
    ...
    'oanquan.help':             { vi: 'Chạm vào 1 ô dân của mình rồi chọn hướng rải trái hoặc phải. Quân sẽ rải dần từng ô một. Nếu ô kế tiếp sau khi rải hết là ô trống mà ô liền sau đó có quân, bé sẽ ăn được hết quân ở ô đó!', en: 'Tap one of your squares, then pick left or right to sow the stones one by one. If the square right after sowing is empty and the next one has stones, you capture them all!', ja: '自分のマスをタップして、みぎかひだりをえらんでいしをまいていこう。まきおわったつぎのマスがからで、そのさきにいしがあれば、ぜんぶとれるよ！', zh: '点击自己的格子，然后选择向左或向右播种。播完后如果下一格是空的，而再下一格有子，就能全部吃掉！', ar: 'انقر إحدى خاناتك ثم اختر اليسار أو اليمين لبذر الأحجار واحدة تلو الأخرى. إذا كانت الخانة التالية فارغة والتي بعدها بها أحجار، تلتقطها جميعًا!' },
    ...
    'loco.help':                { vi: 'Chạm vào các ô theo đúng thứ tự số để chú ếch nhảy qua! Bấm sai không sao, máy sẽ nhắc lại số cần tìm. Có 3 chế độ: đếm từ 1, đếm cách 2, đếm cách 5.', en: 'Tap the squares in the correct number order to make the frog hop! Tapping wrong is okay, the device will remind you of the number to find. 3 modes: counting from 1, counting by 2s, counting by 5s.', ja: 'ただしいじゅんばんでますをタップして、かえるをジャンプさせよう！まちがえてもだいじょうぶ、つぎのかずをおしえてくれるよ。3つのモード：1からかぞえる、2とびでかぞえる、5とびでかぞえる。', zh: '按正确的数字顺序点击方格，让青蛙跳过去！点错了也没关系，设备会提醒你要找的数字。3种模式：从1开始数、按2数、按5数。', ar: 'انقر المربعات بالترتيب الرقمي الصحيح لجعل الضفدع يقفز! لا بأس إن أخطأت، سيذكّرك الجهاز بالرقم المطلوب. 3 أوضاع: العد من 1، العد بالثنائيات، العد بالخماسيات.' },
    ...
    'hocvan.help.ghep':         { vi: 'Chạm các thẻ âm và vần theo đúng thứ tự để ghép thành tiếng đúng với hình. Ghép đúng máy sẽ đánh vần to cho bé nghe!', en: 'Tap the sound and rhyme tiles in order to spell the word matching the picture. Get it right and the device will spell it out loud!', ja: 'おとやいんのカードをじゅんばんにタップして、えにあうことばをつづろう。ただしいとこえにだしてつづってくれるよ！', zh: '按顺序点击声母韵母卡片，拼出与图片匹配的字。拼对了设备会大声拼读！', ar: 'انقر بطاقات الأصوات بالترتيب لتهجئة الكلمة المطابقة للصورة. أصب وسيهجئها الجهاز بصوت عالٍ!' },
    'hocvan.help.dien':         { vi: 'Từ đang thiếu 1 chữ cái, chạm vào chữ cái đúng trong 3 lựa chọn để điền vào chỗ trống.', en: 'The word is missing a letter — tap the correct one out of 3 choices to fill the blank.', ja: 'もじが1つたりないよ。3つのなかからただしいもじをタップしてうめよう。', zh: '单词缺少一个字母，从3个选项中点击正确的字母填空。', ar: 'الكلمة ينقصها حرف — انقر الحرف الصحيح من بين 3 خيارات لملء الفراغ.' },
    'hocvan.help.nghe':         { vi: 'Nghe máy đọc to 1 tiếng, rồi chạm đúng từng chữ cái theo thứ tự trên bàn phím để viết lại tiếng đó.', en: 'Listen to the device read a word aloud, then tap the letters in order on the keyboard to write it down.', ja: 'きかいがよむことばをきいて、キーボードでじゅんばんにもじをタップしてかいてみよう。', zh: '听设备读出一个字，然后按顺序在键盘上点击字母把它写下来。', ar: 'استمع للجهاز وهو يقرأ كلمة، ثم انقر الحروف بالترتيب على لوحة المفاتيح لكتابتها.' },
    ...
    'toan.help.add':            { vi: 'Điền hoặc chọn đáp án đúng cho phép tính cộng trừ hiện trên màn hình.', en: 'Fill in or choose the correct answer for the addition/subtraction problem shown.', ja: 'がめんのたしざん・ひきざんのこたえをえらぶかにゅうりょくしよう。', zh: '填写或选择屏幕上加减法题目的正确答案。', ar: 'املأ أو اختر الإجابة الصحيحة لمسألة الجمع أو الطرح المعروضة.' },
    'toan.help.compare':        { vi: 'Chạm vào dấu lớn hơn, bé hơn hoặc bằng cho phù hợp giữa 2 bên.', en: 'Tap the greater-than, less-than or equal sign that fits between the two sides.', ja: 'りょうがわにあうように、だいなり・しょうなり・イコールのきごうをタップしよう。', zh: '点击大于、小于或等于符号，使其适合两边的数量关系。', ar: 'انقر إشارة أكبر من أو أصغر من أو يساوي المناسبة بين الطرفين.' },
    'toan.help.clock':          { vi: 'Nhìn đồng hồ rồi chọn đúng giờ, hoặc xoay kim đồng hồ cho đúng giờ được yêu cầu.', en: 'Look at the clock and choose the right time, or turn the clock hands to the requested time.', ja: 'とけいをみてただしいじかんをえらぶか、とけいのはりをうごかしてあわせよう。', zh: '看时钟选择正确的时间，或转动时针分针调到要求的时间。', ar: 'انظر إلى الساعة واختر الوقت الصحيح، أو أدر عقارب الساعة إلى الوقت المطلوب.' },
    'toan.help.shape':          { vi: 'Chọn hình khối giống mẫu, hoặc tìm hình tiếp theo đúng quy luật.', en: 'Choose the shape that matches the sample, or find the next shape in the pattern.', ja: 'おてほんとおなじかたちをえらぶか、つぎにくるかたちをみつけよう。', zh: '选择与样本相同的形状，或找出规律中的下一个图形。', ar: 'اختر الشكل المطابق للنموذج، أو أوجد الشكل التالي في النمط.' },
    'toan.help.shop':           { vi: 'Chạm vào các tờ tiền để trả đúng số tiền cần mua hàng.', en: 'Tap the bills to pay the exact amount needed for the items.', ja: 'おかねをタップして、しなもののきんがくどおりにしはらおう。', zh: '点击钞票支付购买商品所需的准确金额。', ar: 'انقر الأوراق النقدية لدفع المبلغ المطلوب بالضبط للسلع.' },
    ...
    'coganh.help':              { vi: 'Chạm vào 1 quân của mình rồi chạm vào ô trống để đi. Đứng giữa 2 quân địch thẳng hàng là "gánh" — cả 2 quân đó đổi màu theo mình! Ai hết quân hoặc không đi được nữa là thua.', en: 'Tap one of your pieces, then tap an empty square to move. Land between two enemy pieces in a line to flip them both to your color! Whoever runs out of pieces or moves loses.', ja: 'じぶんのこまをタップして、あいているマスへうごかそう。てきのこま2つのあいだにはさむと、りょうほうじぶんのいろにかわるよ！こまがなくなったらまけ。', zh: '点击自己的棋子，再点击空格移动。站到两个敌方棋子中间会把它们都变成你的颜色！没有棋子或无法移动就输了。', ar: 'انقر إحدى قطعك ثم انقر خانة فارغة للتحرك. قف بين قطعتين للخصم متحاذيتين لتقلبهما إلى لونك! من تنفد قطعه أو حركاته يخسر.' },
    ...
    'cangua.help':              { vi: 'Bấm xúc xắc để gieo, rồi chạm vào con ngựa của bé (màu đỏ) để đi theo số vừa gieo. Gieo được 6 thì được đi thêm 1 lượt và có thể đưa ngựa ra khỏi chuồng. Về đích trước là thắng!', en: 'Tap the die to roll, then tap your red horse to move that many steps. Rolling a 6 gives an extra turn and lets a horse leave the stable. First one home wins!', ja: 'サイコロをタップしてふって、あかいコマをタップしてすすもう。6がでたらもう1かいふれて、コマをこやからだせるよ。さきにゴールしたらかち！', zh: '点骰子掷骰，再点你的红棋走相应步数。掷到6可以多走一次，还能把棋子从马厩里放出来。先到终点获胜！', ar: 'انقر النرد للرمي، ثم انقر حصانك الأحمر للتحرك بذلك العدد. الرقم 6 يمنحك دورًا إضافيًا ويسمح بإخراج حصان من الإسطبل. أول من يصل للهدف يفوز!' },
    ...
    'card.hubtienganh.chip':    { vi: '16 game tiếng Anh',                  en: '16 English games',                     ja: '16のえいごゲーム',                  zh: '16款英语游戏',                   ar: '16 لعبة إنجليزية' },
    ...
    'nghedoan5.title':          { vi: '👕 Đồ Dùng & Cơ Thể',                 en: '👕 Things & Body',                      ja: '👕 どうぐ・からだ',                 zh: '👕 物品与身体',                  ar: '👕 الأشياء والجسم' },
    'nghedoan5.start':          { vi: 'Nghe từ hoặc câu tiếng Anh rồi chạm đúng hình phù hợp trong 4 lựa chọn!', en: 'Listen to the English word or sentence, then tap the matching picture out of 4 choices!', ja: 'えいごのたんごやぶんをきいて、4つのえからただしいえをタップ！', zh: '听英语单词或句子，然后在4张图里点出正确的那张！', ar: 'استمع للكلمة أو الجملة الإنجليزية ثم انقر الصورة الصحيحة من بين 4 خيارات!' },
    'nghedoan5.play':           { vi: 'NGHE & ĐOÁN ▶',                      en: 'LISTEN & GUESS ▶',                     ja: 'きいてあてる ▶',                    zh: '听音猜图 ▶',                    ar: 'استمع وخمّن ▶' },
    'nghedoan5.help':           { vi: 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về quần áo, đồ dùng gia đình, thiết bị điện tử, cơ thể hay hoạt động hằng ngày — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.', en: 'The device will read a short English word or sentence about clothes, household items, electronics, the body or daily activities — listen carefully, then tap the right picture out of the 4 below! Get 3 correct in a row for a bonus. You can filter by topic at the top.', ja: 'ふく・かじグッズ・でんし・からだ・まいにちのかつどうのたんごやぶんがながれるよ。よくきいて、したの4つからただしいえをタップ！3かいれんぞくでボーナス！うえのボタンでテーマをえらべるよ。', zh: '设备会读一个关于衣服、家居用品、电子设备、身体或日常活动的简短英语单词或句子——认真听，然后在下面4张图里点出正确的那张！连续答对3次有奖励分。可以在顶部按主题筛选。', ar: 'سيقرأ الجهاز كلمة أو جملة إنجليزية قصيرة عن الملابس أو أدوات المنزل أو الإلكترونيات أو الجسم أو الأنشطة اليومية — استمع جيدًا ثم انقر الصورة الصحيحة من بين 4! أجب صحيحًا 3 مرات متتالية لمكافأة. يمكنك التصفية حسب الموضوع أعلى الشاشة.' },
    'nghedoan6.title':          { vi: '🌦️ Thời Tiết & Cảm Xúc',              en: '🌦️ Weather & Emotions',                 ja: '🌦️ てんき・きもち',                zh: '🌦️ 天气与情绪',                 ar: '🌦️ الطقس والمشاعر' },
    'nghedoan6.start':          { vi: 'Nghe từ hoặc câu tiếng Anh rồi chạm đúng hình phù hợp trong 4 lựa chọn!', en: 'Listen to the English word or sentence, then tap the matching picture out of 4 choices!', ja: 'えいごのたんごやぶんをきいて、4つのえからただしいえをタップ！', zh: '听英语单词或句子，然后在4张图里点出正确的那张！', ar: 'استمع للكلمة أو الجملة الإنجليزية ثم انقر الصورة الصحيحة من بين 4 خيارات!' },
    'nghedoan6.play':           { vi: 'NGHE & ĐOÁN ▶',                      en: 'LISTEN & GUESS ▶',                     ja: 'きいてあてる ▶',                    zh: '听音猜图 ▶',                    ar: 'استمع وخمّن ▶' },
    'nghedoan6.help':           { vi: 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về thời tiết, mùa, màu sắc hay cảm xúc — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.', en: 'The device will read a short English word or sentence about weather, seasons, colors or emotions — listen carefully, then tap the right picture out of the 4 below! Get 3 correct in a row for a bonus. You can filter by topic at the top.', ja: 'てんき・きせつ・いろ・きもちのたんごやぶんがながれるよ。よくきいて、したの4つからただしいえをタップ！3かいれんぞくでボーナス！うえのボタンでテーマをえらべるよ。', zh: '设备会读一个关于天气、季节、颜色或情绪的简短英语单词或句子——认真听，然后在下面4张图里点出正确的那张！连续答对3次有奖励分。可以在顶部按主题筛选。', ar: 'سيقرأ الجهاز كلمة أو جملة إنجليزية قصيرة عن الطقس أو الفصول أو الألوان أو المشاعر — استمع جيدًا ثم انقر الصورة الصحيحة من بين 4! أجب صحيحًا 3 مرات متتالية لمكافأة. يمكنك التصفية حسب الموضوع أعلى الشاشة.' },
    'nghedoan7.title':          { vi: '🌍 Quốc Gia & Nghề Nghiệp',           en: '🌍 Countries & Jobs',                   ja: '🌍 くに・しごと',                   zh: '🌍 国家与职业',                  ar: '🌍 الدول والمهن' },
    'nghedoan7.start':          { vi: 'Nghe từ hoặc câu tiếng Anh rồi chạm đúng hình phù hợp trong 4 lựa chọn!', en: 'Listen to the English word or sentence, then tap the matching picture out of 4 choices!', ja: 'えいごのたんごやぶんをきいて、4つのえからただしいえをタップ！', zh: '听英语单词或句子，然后在4张图里点出正确的那张！', ar: 'استمع للكلمة أو الجملة الإنجليزية ثم انقر الصورة الصحيحة من بين 4 خيارات!' },
    'nghedoan7.play':           { vi: 'NGHE & ĐOÁN ▶',                      en: 'LISTEN & GUESS ▶',                     ja: 'きいてあてる ▶',                    zh: '听音猜图 ▶',                    ar: 'استمع وخمّن ▶' },
    'nghedoan7.help':           { vi: 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về quốc gia, số đếm, môn học hay nghề nghiệp — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.', en: 'The device will read a short English word or sentence about countries, numbers, school subjects or jobs — listen carefully, then tap the right picture out of the 4 below! Get 3 correct in a row for a bonus. You can filter by topic at the top.', ja: 'くに・すうじ・かもく・しごとのたんごやぶんがながれるよ。よくきいて、したの4つからただしいえをタップ！3かいれんぞくでボーナス！うえのボタンでテーマをえらべるよ。', zh: '设备会读一个关于国家、数字、学科或职业的简短英语单词或句子——认真听，然后在下面4张图里点出正确的那张！连续答对3次有奖励分。可以在顶部按主题筛选。', ar: 'سيقرأ الجهاز كلمة أو جملة إنجليزية قصيرة عن الدول أو الأرقام أو المواد الدراسية أو المهن — استمع جيدًا ثم انقر الصورة الصحيحة من بين 4! أجب صحيحًا 3 مرات متتالية لمكافأة. يمكنك التصفية حسب الموضوع أعلى الشاشة.' },
    'nghedoan8.title':          { vi: '🏃 Hoạt Động & Đồ Chơi',              en: '🏃 Activities & Toys',                  ja: '🏃 うんどう・おもちゃ',              zh: '🏃 活动与玩具',                  ar: '🏃 الأنشطة والألعاب' },
    'nghedoan8.start':          { vi: 'Nghe từ hoặc câu tiếng Anh rồi chạm đúng hình phù hợp trong 4 lựa chọn!', en: 'Listen to the English word or sentence, then tap the matching picture out of 4 choices!', ja: 'えいごのたんごやぶんをきいて、4つのえからただしいえをタップ！', zh: '听英语单词或句子，然后在4张图里点出正确的那张！', ar: 'استمع للكلمة أو الجملة الإنجليزية ثم انقر الصورة الصحيحة من بين 4 خيارات!' },
    'nghedoan8.play':           { vi: 'NGHE & ĐOÁN ▶',                      en: 'LISTEN & GUESS ▶',                     ja: 'きいてあてる ▶',                    zh: '听音猜图 ▶',                    ar: 'استمع وخمّن ▶' },
    'nghedoan8.help':           { vi: 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về hoạt động thể chất, đồ chơi, sở thích ngoài trời, địa điểm công cộng hay nhạc cụ — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Nếu chọn sai, máy sẽ gợi ý để bé chọn lại một lần nữa. Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.', en: 'The device will read a short English word or sentence about physical activities, toys, outdoor hobbies, public places or musical instruments — listen carefully, then tap the right picture out of the 4 below! If you pick wrong, you get a hint and one more try. Get 3 correct in a row for a bonus. You can filter by topic at the top.', ja: 'うんどう・おもちゃ・そとあそび・こうきょうばしょ・がっきのたんごやぶんがながれるよ。よくきいて、したの4つからただしいえをタップ！まちがえたらヒントをきいてもういちどえらべるよ。3かいれんぞくでボーナス！うえのボタンでテーマをえらべるよ。', zh: '设备会读一个关于体育活动、玩具、户外爱好、公共场所或乐器的简短英语单词或句子——认真听，然后在下面4张图里点出正确的那张！选错了会有提示，可以再选一次。连续答对3次有奖励分。可以在顶部按主题筛选。', ar: 'سيقرأ الجهاز كلمة أو جملة إنجليزية قصيرة عن الأنشطة البدنية أو الألعاب أو الهوايات الخارجية أو الأماكن العامة أو الآلات الموسيقية — استمع جيدًا ثم انقر الصورة الصحيحة من بين 4! إذا أخطأت ستحصل على تلميح ومحاولة أخرى. أجب صحيحًا 3 مرات متتالية لمكافأة. يمكنك التصفية حسب الموضوع أعلى الشاشة.' },
    'nghedoan9.title':          { vi: '🍳 Nhà Bếp & Công Nghệ',              en: '🍳 Kitchen & Technology',               ja: '🍳 キッチン・テクノロジー',          zh: '🍳 厨房与科技',                  ar: '🍳 المطبخ والتكنولوجيا' },
    'nghedoan9.start':          { vi: 'Nghe từ hoặc câu tiếng Anh rồi chạm đúng hình phù hợp trong 4 lựa chọn!', en: 'Listen to the English word or sentence, then tap the matching picture out of 4 choices!', ja: 'えいごのたんごやぶんをきいて、4つのえからただしいえをタップ！', zh: '听英语单词或句子，然后在4张图里点出正确的那张！', ar: 'استمع للكلمة أو الجملة الإنجليزية ثم انقر الصورة الصحيحة من بين 4 خيارات!' },
    'nghedoan9.play':           { vi: 'NGHE & ĐOÁN ▶',                      en: 'LISTEN & GUESS ▶',                     ja: 'きいてあてる ▶',                    zh: '听音猜图 ▶',                    ar: 'استمع وخمّن ▶' },
    'nghedoan9.help':           { vi: 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về nấu ăn, hương vị, rau củ hay thiết bị công nghệ — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Nếu chọn sai, máy sẽ gợi ý để bé chọn lại một lần nữa. Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.', en: 'The device will read a short English word or sentence about cooking, tastes, vegetables or technology — listen carefully, then tap the right picture out of the 4 below! If you pick wrong, you get a hint and one more try. Get 3 correct in a row for a bonus. You can filter by topic at the top.', ja: 'りょうり・あじ・やさい・テクノロジーのたんごやぶんがながれるよ。よくきいて、したの4つからただしいえをタップ！まちがえたらヒントをきいてもういちどえらべるよ。3かいれんぞくでボーナス！うえのボタンでテーマをえらべるよ。', zh: '设备会读一个关于烹饪、味道、蔬菜或科技的简短英语单词或句子——认真听，然后在下面4张图里点出正确的那张！选错了会有提示，可以再选一次。连续答对3次有奖励分。可以在顶部按主题筛选。', ar: 'سيقرأ الجهاز كلمة أو جملة إنجليزية قصيرة عن الطبخ أو المذاقات أو الخضروات أو التكنولوجيا — استمع جيدًا ثم انقر الصورة الصحيحة من بين 4! إذا أخطأت ستحصل على تلميح ومحاولة أخرى. أجب صحيحًا 3 مرات متتالية لمكافأة. يمكنك التصفية حسب الموضوع أعلى الشاشة.' },
    'ontap.title':              { vi: '🎓 Ôn Tập Tổng Hợp',                  en: '🎓 Grand Review',                       ja: '🎓 まとめふくしゅう',               zh: '🎓 综合复习',                    ar: '🎓 المراجعة الشاملة' },
    'ontap.start':              { vi: 'Ôn lại toàn bộ từ vựng của cả 9 game Nghe & Đoán — nghe rồi chạm đúng hình!', en: 'Review every word from all 9 Listen & Guess games — listen, then tap the right picture!', ja: '9つのゲームのたんごをぜんぶふくしゅう！きいてただしいえをタップ！', zh: '复习全部9款听音猜图游戏的单词——听完点出正确的图！', ar: 'راجع كل كلمات ألعاب الاستماع والتخمين التسع — استمع ثم انقر الصورة الصحيحة!' },
    'ontap.play':               { vi: 'ÔN TẬP ▶',                           en: 'REVIEW ▶',                             ja: 'ふくしゅう ▶',                      zh: '复习 ▶',                        ar: 'مراجعة ▶' },
    'ontap.help':               { vi: 'Đây là màn ôn tập trộn toàn bộ từ vựng của cả 9 game Nghe & Đoán! Máy đọc một từ hoặc câu tiếng Anh — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé. Nếu chọn sai, máy sẽ gợi ý để bé chọn lại một lần nữa. Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng. Hàng nút trên cùng cho bé chọn ôn theo từng game hoặc trộn tất cả.', en: 'This is a grand review mixing every word from all 9 Listen & Guess games! Listen carefully, then tap the right picture out of the 4 below. If you pick wrong, you get a hint and one more try. Get 3 correct in a row for a bonus. Use the buttons at the top to review one game or mix them all.', ja: '9つのゲームのたんごをぜんぶまぜたふくしゅうだよ！よくきいて、したの4つからただしいえをタップ。まちがえたらヒントをきいてもういちどえらべるよ。3かいれんぞくでボーナス！うえのボタンでゲームごとにえらべるよ。', zh: '这是混合全部9款听音猜图游戏单词的综合复习！认真听，然后在下面4张图里点出正确的那张。选错了会有提示，可以再选一次。连续答对3次有奖励分。顶部按钮可以按游戏复习或全部混合。', ar: 'هذه مراجعة شاملة تمزج كل كلمات ألعاب الاستماع والتخمين التسع! استمع جيدًا ثم انقر الصورة الصحيحة من بين 4. إذا أخطأت ستحصل على تلميح ومحاولة أخرى. أجب صحيحًا 3 مرات متتالية لمكافأة. أزرار الأعلى للمراجعة حسب اللعبة أو مزج الكل.' },
    'card.chonbe.title':        { vi: 'Bé Nào Đang Chơi?',                  en: "Who's Playing?",                       ja: 'だれがあそぶ？',                    zh: '谁在玩？',                      ar: 'من يلعب؟' },
    'card.chonbe.desc':         { vi: 'Mỗi bé một hồ sơ riêng — chạm avatar của con để điểm, sao thưởng và quà được lưu đúng cho từng bé (cần bố mẹ cài server 1 lần).', en: 'One profile per child — tap your avatar so points, stars and gifts are saved for the right kid (parent sets up the server once).', ja: 'こどもごとにプロフィール！アバターをタップすると、ポイント・スター・プレゼントがちゃんとほぞんされるよ。', zh: '每个孩子一个档案——点自己的头像，积分、星星和礼物都会记在对的孩子名下（家长需先配置一次服务器）。', ar: 'ملف لكل طفل — انقر صورتك لتُحفظ النقاط والنجوم والهدايا للطفل الصحيح (يعدّه الوالدان مرة واحدة).' },
    'card.chonbe.chip':         { vi: 'Hồ sơ từng bé',                      en: 'Per-child profiles',                   ja: 'こどもべつプロフィール',            zh: '每孩档案',                      ar: 'ملف لكل طفل' },
    'card.tuqua.title':         { vi: 'Tủ Quà & Vườn Hoa',                  en: 'Gift Box & Garden',                    ja: 'プレゼントとおはなばたけ',          zh: '礼物柜与花园',                  ar: 'صندوق الهدايا والحديقة' },
    'card.tuqua.desc':          { vi: 'Bé đổi sao ⭐ kiếm được từ các game học lấy kẹo, hoa trồng vườn, thú cưng và danh hiệu — học chăm mỗi ngày còn được tặng kẹo miễn phí!', en: 'Trade the stars ⭐ you earn in learning games for candy, garden flowers, pets and titles — study daily and get free candy too!', ja: 'ゲームでためたスター⭐をキャンディ・おはな・ペットとこうかん！まいにちがんばるとむりょうキャンディも！', zh: '用学习游戏赚的星星⭐换糖果、种花、宠物和称号——每天勤学还送免费糖果！', ar: 'بدّل النجوم ⭐ التي تكسبها من ألعاب التعلم بالحلوى والزهور والحيوانات الأليفة والألقاب — وادرس يوميًا لتحصل على حلوى مجانية!' },
    'card.tuqua.chip':          { vi: 'Phần thưởng của bé',                 en: "Kid's rewards",                        ja: 'ごほうび',                          zh: '孩子的奖励',                    ar: 'مكافآت الطفل' },
    'card.phuhuynh.title':      { vi: 'Trang Phụ Huynh',                    en: 'Parent Dashboard',                     ja: 'ほごしゃページ',                    zh: '家长页面',                      ar: 'صفحة الوالدين' },
    'card.phuhuynh.desc':       { vi: 'Dành cho bố mẹ: xem tiến độ và từ hay sai của từng bé (từ bất kỳ máy nào), gửi quà kèm lời nhắn, cài đặt giờ chơi.', en: "For parents: see each child's progress and tricky words (from any device), send gifts with a message, set play-time limits.", ja: 'ほごしゃむけ：こどものしんちょくやにがてなたんごをどのたんまつからでもチェック。プレゼントやプレイじかんせっていも。', zh: '家长专用：在任何设备上查看每个孩子的进度和易错单词，发送带留言的礼物，设置游戏时长。', ar: 'للوالدين: تابع تقدم كل طفل وكلماته الصعبة من أي جهاز، أرسل هدايا مع رسالة، واضبط وقت اللعب.' },
    'card.phuhuynh.chip':       { vi: 'Cần đăng nhập',                      en: 'Login required',                       ja: 'ログインひつよう',                  zh: '需登录',                        ar: 'يتطلب تسجيل الدخول' },
    ...
    'dientu.help.ducks':        { vi: 'Chạm vào con vịt bay qua màn hình để bắn hạ! Chọn chế độ "Chỉ số chẵn" nếu muốn chỉ bắn vịt mang số chẵn thôi.', en: 'Tap the ducks flying across the screen to shoot them down! Choose "Even numbers only" to only shoot ducks carrying even numbers.', ja: 'がめんをとぶあひるをタップしてうちおとそう！「ぐうすうだけ」モードでは、ぐうすうのあひるだけうとう。', zh: '点击飞过屏幕的鸭子把它打下来！选择"仅偶数"模式只打带偶数的鸭子。', ar: 'انقر البط الطائر عبر الشاشة لإسقاطه! اختر "الأرقام الزوجية فقط" لضرب البط ذي الأرقام الزوجية فقط.' },
    'dientu.help.bricks':       { vi: 'Kéo thanh trượt để đỡ quả bóng nảy lên, phá hết các viên gạch phía trên nhé! Đừng để bóng rơi xuống dưới.', en: 'Drag the paddle to bounce the ball up and break all the bricks above! Don\'t let the ball fall to the bottom.', ja: 'バーをうごかしてボールをはねかえし、うえのブロックをぜんぶこわそう！ボールをおとさないでね。', zh: '拖动挡板把球弹起来，打碎上面所有的砖块！别让球掉到下面去。', ar: 'اسحب المضرب لارتداد الكرة وتكسير كل الطوب أعلاه! لا تدع الكرة تسقط إلى الأسفل.' },
    'dientu.help.racer':        { vi: 'Vuốt trái phải hoặc chạm vào làn đường để né các xe khác, đi được càng xa càng nhiều điểm!', en: 'Swipe left/right or tap a lane to dodge other cars — the farther you go, the more points you get!', ja: 'ひだりみぎにスワイプするか、レーンをタップしてほかのくるまをよけよう。とおくまでいくほどとくてん！', zh: '左右滑动或点击车道躲避其他车辆，走得越远分数越高！', ar: 'اسحب يسارًا/يمينًا أو انقر مسارًا لتفادي السيارات الأخرى — كلما ذهبت أبعد سجلت نقاطًا أكثر!' },
