// Điều phối Luyện Thi PET (B1 Preliminary) — bản "KHOÁ CẤP ĐỘ" tách riêng từ
...
// người dùng "gộp vậy bé rối" nên PET được tách thành mục riêng biệt — bấm
// vào là vào thẳng PET, không phải chọn cấp độ trước.
//
// Dùng lại NGUYÊN VẸN engine/dữ liệu từ exam-prep/ (cùng Unit/misses.js) —
// chỉ khoá cứng LEVEL_ID = 'pet' và bỏ hẳn màn chọn cấp độ khỏi luồng UI.
...
const LEVEL_ID = 'pet';
const LEVEL_LABEL = '🏅 PET (B1 Preliminary)';
...
// Hook cho e2e test
window.__expet = { state, startStudyQuiz, startMockTest };
