// Điều phối Nghe & Đoán: Nhà Bếp & Công Nghệ — máy đọc 1 từ hoặc câu tiếng
// Anh ngắn (giọng en-US thật, câu dài đọc chậm hơn), bé chạm đúng hình phù
// hợp trong 4 lựa chọn — lọc được theo chủ đề (chế biến & nhà bếp / hương vị
// & cảm nhận / rau củ / công nghệ) hoặc chơi lẫn cả 4 chủ đề ("Tất cả").

import {
  TOPICS, makeGame, currentRound, chooseOption, promptFor, rateFor,
} from './nhabepcongnghe.js';
...
sayInstruction(t('nghedoan9.help', 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về nấu ăn, hương vị, rau củ hay thiết bị công nghệ — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Nếu chọn sai, máy sẽ gợi ý để bé chọn lại một lần nữa. Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.'));
startRound();

// Hook cho e2e test
window.__nghedoan9 = { state, startRound };
