// Điều phối Nghe & Đoán: Muôn Loài & Vũ Trụ — máy đọc 1 từ hoặc câu tiếng Anh ngắn
// (giọng en-US thật, câu dài đọc chậm hơn), bé chạm đúng hình phù hợp trong 4 lựa
// chọn — lọc được theo chủ đề (động vật hoang dã / sinh vật biển & côn trùng /
// hàng không & vũ trụ / toán học & hình khối / loài chim) hoặc chơi lẫn cả 5
// chủ đề ("Tất cả").
...
// Hook cho e2e test
window.__nghedoan3 = { state, startRound };
