// Điều phối Luyện Thi TOEFL Junior — bản "KHOÁ CẤP ĐỘ" tách riêng từ
...
// người dùng "gộp vậy bé rối" nên TOEFL Junior được tách thành mục riêng
// biệt — bấm vào là vào thẳng TOEFL Junior, không phải chọn cấp độ trước.
//
// Dùng lại NGUYÊN VẸN engine/dữ liệu từ exam-prep/ (cùng Unit/misses.js) —
// chỉ khoá cứng LEVEL_ID = 'toefl-junior' và bỏ hẳn màn chọn cấp độ khỏi
// luồng UI.
...
// Hook cho e2e test
window.__extofljr = { state, startStudyQuiz, startMockTest };
