// Điều phối Nghe & Đoán: Thời Tiết, Màu Sắc & Cảm Xúc — máy đọc 1 từ hoặc câu
// tiếng Anh ngắn (giọng en-US thật, câu dài đọc chậm hơn), bé chạm đúng hình
// phù hợp trong 4 lựa chọn — lọc được theo chủ đề (thời tiết / mùa & thời
// gian / màu sắc / cảm xúc / tính từ đối lập) hoặc chơi lẫn cả 5 chủ đề
// ("Tất cả").

import {
  TOPICS, makeGame, currentRound, chooseOption, promptFor, rateFor,
} from './thoitietcamxuc.js';
...
sayInstruction(t('nghedoan6.help', 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về thời tiết, mùa, màu sắc hay cảm xúc — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.'));
startRound();

// Hook cho e2e test
window.__nghedoan6 = { state, startRound };
