...
export async function generatePassages({ apiKey, model = DEFAULT_DEEPSEEK_MODEL, levelLabel, count = 3 }) {
...
/** @param {'grammar'|'vocab'} quizType xem shared/groq.js generateGrammarQuiz() cho cùng logic. */
export async function generateGrammarQuiz({ apiKey, model = DEFAULT_DEEPSEEK_MODEL, levelLabel, count = 5, quizType = 'grammar' }) {
