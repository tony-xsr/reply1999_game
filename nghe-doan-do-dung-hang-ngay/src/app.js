// Điều phối Nghe & Đoán: Đồ Dùng & Cơ Thể — máy đọc 1 từ hoặc câu tiếng Anh
// ngắn (giọng en-US thật, câu dài đọc chậm hơn), bé chạm đúng hình phù hợp
// trong 4 lựa chọn — lọc được theo chủ đề (quần áo & giày dép / đồ dùng gia
// đình / thiết bị điện tử / bộ phận cơ thể / hoạt động hằng ngày) hoặc chơi
// lẫn cả 5 chủ đề ("Tất cả").
...
sayInstruction(t('nghedoan5.help', 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về quần áo, đồ dùng gia đình, thiết bị điện tử, cơ thể hay hoạt động hằng ngày — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.'));
startRound();

// Hook cho e2e test
window.__nghedoan5 = { state, startRound };
