...
export const GOING_TO_WILL_SCENARIOS = [
  ...
  // ----- Bổ sung vòng mục tiêu 1150 -----
  {
    cue: '🎨', cueLabel: 'Đã mua sẵn màu vẽ và khung tranh — kế hoạch có từ trước', subject: 'He', verb: 'paint a mural on the wall', correctForm: 'going-to',
  },
  {
    cue: '🧁', cueLabel: 'Bạn vừa đề nghị giúp — quyết định ngay lúc đó', subject: 'I', verb: 'help you frost the cupcakes', correctForm: 'will',
  },
  {
    cue: '🎒', cueLabel: 'Đã xếp sẵn đồ trong ba lô từ tối hôm trước — kế hoạch có sẵn', subject: 'She', verb: 'hike up the mountain tomorrow', correctForm: 'going-to',
  },
  {
    cue: '☎️', cueLabel: 'Điện thoại bàn đang đổ chuông — quyết định ngay lúc đó', subject: 'You', verb: 'pick up the phone', correctForm: 'will',
  },
  {
    cue: '🏫', cueLabel: 'Đã đăng ký nhập học từ tháng trước — kế hoạch có sẵn', subject: 'They', verb: 'transfer to a new school', correctForm: 'going-to',
  },
  {
    cue: '🥶', cueLabel: 'Bạn vừa run vì lạnh — quyết định ngay lúc đó, đề nghị giúp đỡ', subject: 'We', verb: 'lend you a warm blanket', correctForm: 'will',
  },
  {
    cue: '🎻', cueLabel: 'Đã tập luyện nhiều tuần cho buổi biểu diễn — kế hoạch có sẵn', subject: 'He', verb: 'perform the violin solo', correctForm: 'going-to',
  },
  {
    cue: '🚪', cueLabel: 'Chuông cửa vừa reo — quyết định ngay lúc đó', subject: 'She', verb: 'answer the intercom', correctForm: 'will',
  },
  {
    cue: '🏕️', cueLabel: 'Đã đặt chỗ cắm trại từ đầu tháng — kế hoạch có sẵn', subject: 'We', verb: 'camp near the waterfall next week', correctForm: 'going-to',
  },
  {
    cue: '🧯', cueLabel: 'Thấy khói bốc lên — quyết định ngay lúc đó', subject: 'I', verb: 'put out the small fire', correctForm: 'will',
  },
  {
    cue: '🎂', cueLabel: 'Đã đặt bánh và trang trí từ hôm trước — kế hoạch có sẵn', subject: 'They', verb: 'throw a surprise party', correctForm: 'going-to',
  },
  {
    cue: '💧', cueLabel: 'Vòi nước vừa bị vỡ ống — quyết định ngay lúc đó', subject: 'He', verb: 'shut off the main valve', correctForm: 'will',
  },
  {
    cue: '📚', cueLabel: 'Đã đăng ký khóa học trực tuyến từ tuần trước — kế hoạch có sẵn', subject: 'She', verb: 'take an online coding course', correctForm: 'going-to',
  },
  {
    cue: '🐝', cueLabel: 'Có con ong bay vào phòng — quyết định ngay lúc đó', subject: 'You', verb: 'open the window to let it out', correctForm: 'will',
  },
  {
    cue: '🚴', cueLabel: 'Đã đăng ký giải đua từ tháng trước — kế hoạch có sẵn', subject: 'He', verb: 'race in the marathon', correctForm: 'going-to',
  },
  {
    cue: '🧊', cueLabel: 'Đá trong ly vừa tan hết — quyết định ngay lúc đó', subject: 'I', verb: 'get some more ice cubes', correctForm: 'will',
  },
  {
    cue: '🏖️', cueLabel: 'Đã đặt vé máy bay và khách sạn từ tháng trước — kế hoạch có sẵn', subject: 'We', verb: 'spend the holiday at the beach', correctForm: 'going-to',
  },
  {
    cue: '📦', cueLabel: 'Kiện hàng vừa tới trước cửa — quyết định ngay lúc đó', subject: 'She', verb: 'bring the parcel inside', correctForm: 'will',
  },
  {
    cue: '🎭', cueLabel: 'Đã tập kịch bản nhiều tháng nay — kế hoạch có sẵn', subject: 'They', verb: 'stage the school drama', correctForm: 'going-to',
  },
  {
    cue: '🕯️', cueLabel: 'Ngọn nến vừa bị gió thổi tắt — quyết định ngay lúc đó', subject: 'I', verb: 'relight the candle', correctForm: 'will',
  },
  {
    cue: '🧵', cueLabel: 'Đã mua vải và chỉ từ cuối tuần trước — kế hoạch có sẵn', subject: 'She', verb: 'sew a new costume', correctForm: 'going-to',
  },
  {
    cue: '🚑', cueLabel: 'Bạn vừa bị ngã và chảy máu — quyết định ngay lúc đó', subject: 'We', verb: 'take you to the clinic', correctForm: 'will',
  },
  {
    cue: '🌉', cueLabel: 'Đã lên lịch trình tham quan cây cầu từ hôm qua — kế hoạch có sẵn', subject: 'He', verb: 'cross the old bridge', correctForm: 'going-to',
  },
  {
    cue: '📵', cueLabel: 'Chuông báo động vừa kêu — quyết định ngay lúc đó', subject: 'She', verb: 'silence the loud alarm', correctForm: 'will',
  },
  {
    cue: '🏆', cueLabel: 'Đã luyện tập không ngừng cho trận chung kết — kế hoạch có sẵn', subject: 'They', verb: 'compete in the final match', correctForm: 'going-to',
  },
];
...
export const MODAL_SITUATIONS = [
  ...
  // ----- Bổ sung vòng mục tiêu 1150 -----
  { icon: '🦽', label: 'Biển bắt buộc dùng đường dốc thay vì cầu thang', verb: 'use the ramp instead of the stairs', modal: 'must' },
  { icon: '🚯', label: 'Biển cấm đổ hóa chất xuống sông', verb: 'dump chemicals into the river', modal: "mustn't" },
  { icon: '📵', label: 'Quy định bắt buộc tắt chuông điện thoại khi thi', verb: 'silence your phone during the exam', modal: 'must' },
  { icon: '🧴', label: 'Lời khuyên nên dưỡng ẩm da vào mùa đông', verb: 'moisturize your skin in winter', modal: 'should' },
  { icon: '🍭', label: 'Lời khuyên không nên cho trẻ nhỏ ăn kẹo cứng', verb: 'give young children hard candy', modal: "shouldn't" },
  { icon: '🪖', label: 'Quy định bắt buộc đội mũ cứng trong đường hầm', verb: 'wear a hard hat inside the tunnel', modal: 'must' },
  { icon: '🚭', label: 'Biển cấm hút thuốc lá điện tử trong nhà hàng', verb: 'vape inside the restaurant', modal: "mustn't" },
  { icon: '💤', label: 'Lời khuyên nên giữ giờ giấc ngủ đều đặn', verb: 'keep a regular sleep schedule', modal: 'should' },
  { icon: '📶', label: 'Lời khuyên không nên tải tệp từ trang web lạ', verb: 'download files from unknown websites', modal: "shouldn't" },
  { icon: '🧤', label: 'Quy định bắt buộc đeo găng tay khi chạm mảnh vỡ', verb: 'wear gloves when touching broken glass', modal: 'must' },
  { icon: '🚪', label: 'Cảnh báo không được chèn cửa thoát hiểm mở sẵn', verb: 'prop open the fire door', modal: "mustn't" },
  { icon: '🥗', label: 'Lời khuyên nên ăn nhiều loại rau củ đầy màu sắc', verb: 'eat a variety of colorful vegetables', modal: 'should' },
  { icon: '🎮', label: 'Lời khuyên không nên chơi game ngay trước khi ngủ', verb: 'play games right before bedtime', modal: "shouldn't" },
  { icon: '🛴', label: 'Quy định bắt buộc đeo bảo vệ đầu gối khi đi xe trượt', verb: 'wear knee pads when riding a scooter', modal: 'must' },
  { icon: '🚬', label: 'Cảnh báo không được hút thuốc gần bình oxy', verb: 'smoke near the oxygen tanks', modal: "mustn't" },
  { icon: '📧', label: 'Lời khuyên nên đọc kỹ email trước khi gửi', verb: 'proofread emails before sending them', modal: 'should' },
  { icon: '🍫', label: 'Lời khuyên không nên giấu đồ ăn vặt của anh chị em', verb: 'hide snacks from your siblings', modal: "shouldn't" },
  { icon: '🦷', label: 'Lời khuyên nên khám răng định kỳ 2 lần/năm', verb: 'visit the dentist twice a year', modal: 'should' },
  { icon: '🚫', label: 'Cảnh báo không được chen ngang khi xếp hàng mua vé', verb: 'cut in line at the ticket counter', modal: "mustn't" },
  { icon: '🌱', label: 'Lời khuyên nên ủ rác hữu cơ làm phân compost', verb: 'recycle organic waste in the compost bin', modal: 'should' },
  { icon: '📱', label: 'Lời khuyên không nên trả lời tin nhắn từ người lạ', verb: "reply to strangers' messages online", modal: "shouldn't" },
  { icon: '🧯', label: 'Quy định bắt buộc nhớ rõ điểm tập trung khi có sự cố', verb: 'memorize the emergency assembly point', modal: 'must' },
  { icon: '🚦', label: 'Cảnh báo không được băng qua khi rào chắn đã hạ', verb: 'cross the tracks when the barrier is down', modal: "mustn't" },
  { icon: '🧘', label: 'Lời khuyên nên tập thở sâu khi căng thẳng', verb: 'practice deep breathing when stressed', modal: 'should' },
  { icon: '🎧', label: 'Lời khuyên không nên nghe nhạc quá to trong nhiều giờ', verb: 'listen to music at full volume for hours', modal: "shouldn't" },
];
...
const CONDITIONAL_TEMPLATES = [
  ...
  // ----- Bổ sung vòng mục tiêu 1150 -----
  { cue: '🚴', label: 'Đội mũ bảo hiểm khi trượt ván → tránh chấn thương đầu', ifVerb: 'wear', ifVerbPast: 'wore', ifRest: 'a helmet while skateboarding', resultVerb: 'avoid', resultRest: 'a head injury' },
  { cue: '📅', label: 'Lên kế hoạch trước → ít căng thẳng hơn', ifVerb: 'plan', ifVerbPast: 'planned', ifRest: 'ahead', resultVerb: 'feel', resultRest: 'less stressed' },
  { cue: '🧺', label: 'Gấp quần áo ngay khi khô → phòng luôn gọn gàng', ifVerb: 'fold', ifVerbPast: 'folded', ifRest: 'the laundry right away', resultVerb: 'keep', resultRest: '{poss} room tidy' },
  { cue: '🎣', label: 'Dậy sớm để đi câu cá → bắt được nhiều cá hơn', ifVerb: 'wake', ifVerbPast: 'woke', ifRest: 'up early to go fishing', resultVerb: 'catch', resultRest: 'more fish' },
  { cue: '🚿', label: 'Tắm nhanh hơn → tiết kiệm nước hơn', ifVerb: 'shower', ifVerbPast: 'showered', ifRest: 'more quickly', resultVerb: 'save', resultRest: 'more water' },
  { cue: '📵', label: 'Tắt điện thoại trước khi ngủ → ngủ ngon hơn', ifVerb: 'turn', ifVerbPast: 'turned', ifRest: 'off {poss} phone before bed', resultVerb: 'sleep', resultRest: 'better' },
  { cue: '🧑‍🍳', label: 'Học nấu ăn cơ bản → tự lo được bữa ăn cho mình', ifVerb: 'learn', ifVerbPast: 'learned', ifRest: 'basic cooking', resultVerb: 'cook', resultRest: '{poss} own meals' },
  { cue: '🚲', label: 'Bơm lốp xe đạp đầy → đạp xe dễ dàng hơn', ifVerb: 'pump', ifVerbPast: 'pumped', ifRest: 'up the tires', resultVerb: 'cycle', resultRest: 'more easily' },
  { cue: '🗑️', label: 'Phân loại rác đúng cách → giúp tái chế hiệu quả hơn', ifVerb: 'sort', ifVerbPast: 'sorted', ifRest: 'the rubbish correctly', resultVerb: 'help', resultRest: 'recycling work better' },
  { cue: '📖', label: 'Đọc trước bài học → hiểu bài nhanh hơn trên lớp', ifVerb: 'preview', ifVerbPast: 'previewed', ifRest: 'the lesson', resultVerb: 'understand', resultRest: 'the class faster' },
  { cue: '🧵', label: 'Vá lại chiếc áo rách → mặc được lâu hơn', ifVerb: 'mend', ifVerbPast: 'mended', ifRest: 'the torn shirt', resultVerb: 'wear', resultRest: 'it much longer' },
  { cue: '🎯', label: 'Luyện ném phi tiêu mỗi tối → ném chính xác hơn', ifVerb: 'rehearse', ifVerbPast: 'rehearsed', ifRest: 'darts every evening', resultVerb: 'aim', resultRest: 'more accurately' },
  { cue: '🧊', label: 'Để đồ uống vào tủ lạnh sớm → có đồ uống mát lạnh', ifVerb: 'chill', ifVerbPast: 'chilled', ifRest: 'the drinks early', resultVerb: 'have', resultRest: 'a cold drink ready' },
  { cue: '🪟', label: 'Lau cửa sổ thường xuyên → phòng luôn sáng sủa', ifVerb: 'wipe', ifVerbPast: 'wiped', ifRest: 'the windows regularly', resultVerb: 'keep', resultRest: 'the room bright' },
  { cue: '🧑‍🌾', label: 'Bón phân cho cây đúng lịch → cây phát triển tốt hơn', ifVerb: 'fertilize', ifVerbPast: 'fertilized', ifRest: 'the plants on schedule', resultVerb: 'grow', resultRest: 'much healthier plants' },
  { cue: '🧦', label: 'Xâu tất theo đôi → không bao giờ mất tất lẻ', ifVerb: 'pair', ifVerbPast: 'paired', ifRest: 'the socks together', resultVerb: 'keep', resultRest: 'every sock in a pair' },
  { cue: '🔋', label: 'Sạc đầy pin đèn pin → dùng được lâu hơn khi cần', ifVerb: 'charge', ifVerbPast: 'charged', ifRest: 'the flashlight fully', resultVerb: 'have', resultRest: 'light for much longer when needed' },
  { cue: '🧽', label: 'Cọ sạch bếp sau khi nấu → bếp luôn sạch sẽ', ifVerb: 'scrub', ifVerbPast: 'scrubbed', ifRest: 'the stove after cooking', resultVerb: 'keep', resultRest: 'the kitchen clean' },
  { cue: '🚪', label: 'Khóa cửa trước khi ra ngoài → nhà luôn an toàn', ifVerb: 'lock', ifVerbPast: 'locked', ifRest: 'the door before leaving', resultVerb: 'keep', resultRest: 'the house safe' },
  { cue: '🖼️', label: 'Treo tranh ngay ngắn → phòng khách đẹp hơn', ifVerb: 'hang', ifVerbPast: 'hung', ifRest: 'the paintings straight', resultVerb: 'improve', resultRest: 'the living room' },
  { cue: '🎒', label: 'Chuẩn bị cặp sách tối hôm trước → sáng ra không vội vàng', ifVerb: 'pack', ifVerbPast: 'packed', ifRest: '{poss} bag the night before', resultVerb: 'rush', resultRest: 'less in the morning' },
  { cue: '🧴', label: 'Bôi kem chống nắng trước khi ra ngoài → tránh bị cháy nắng', ifVerb: 'apply', ifVerbPast: 'applied', ifRest: 'sunscreen before going out', resultVerb: 'avoid', resultRest: 'getting sunburned' },
  { cue: '📮', label: 'Gửi thư sớm → nhận được lời cảm ơn kịp lễ', ifVerb: 'mail', ifVerbPast: 'mailed', ifRest: 'the letter early', resultVerb: 'receive', resultRest: 'a thank-you note before the holiday' },
  { cue: '🧑‍💻', label: 'Sao lưu tệp thường xuyên → không bao giờ mất dữ liệu quan trọng', ifVerb: 'back', ifVerbPast: 'backed', ifRest: 'up {poss} files regularly', resultVerb: 'protect', resultRest: '{poss} important data' },
  { cue: '🚰', label: 'Sửa vòi nước bị rò ngay → tiết kiệm được nhiều nước', ifVerb: 'fix', ifVerbPast: 'fixed', ifRest: 'the leaking tap right away', resultVerb: 'save', resultRest: 'a lot of water' },
];
...
const SENTENCE_BUILDER_TEMPLATES = [
  ...
  // ----- Bổ sung vòng mục tiêu 1150 -----
  { icon: '🙂', buildEn: (c, v) => `${c.subject} is used to ${v.ing} every morning.`, buildVi: (cv, vv) => `${cv} đã quen với việc ${vv} mỗi sáng.` },
  { icon: '🙅', buildEn: (c, v) => `${c.subject} can't stand ${v.ing}.`, buildVi: (cv, vv) => `${cv} không chịu nổi việc ${vv}.` },
  { icon: '🏁', buildEn: (c, v) => `${c.subject} ends up ${v.ing} every weekend.`, buildVi: (cv, vv) => `${cv} rốt cuộc lại ${vv} vào mỗi cuối tuần.` },
  { icon: '✅', buildEn: (c, v) => `${c.subject} finishes ${v.ing} before dinner.`, buildVi: (cv, vv) => `${cv} ${vv} xong trước bữa tối.` },
  { icon: '💕', buildEn: (c, v) => `${c.subject} is fond of ${v.ing} on rainy days.`, buildVi: (cv, vv) => `${cv} rất thích ${vv} vào những ngày mưa.` },
  { icon: '🌟', buildEn: (c, v) => `${c.subject} would love to ${v.base} someday.`, buildVi: (cv, vv) => `${cv} rất muốn ${vv} một ngày nào đó.` },
];
...
export const PASSIVE_SCENARIOS = [
  ...
  // ----- Bổ sung vòng mục tiêu 1150 -----
  { agentIcon: '👩‍🏫', agentNoun: 'the teacher', objectIcon: '📝', objectNoun: 'the essays', objectPlural: true, base: 'mark', past: 'marked', pp: 'marked', s3: 'marks' },
  { agentIcon: '🧑‍🌾', agentNoun: 'the farmer', objectIcon: '🌾', objectNoun: 'the wheat', objectPlural: false, base: 'thresh', past: 'threshed', pp: 'threshed', s3: 'threshes' },
  { agentIcon: '👷', agentNoun: 'the workers', objectIcon: '🧱', objectNoun: 'the wall', objectPlural: false, base: 'plaster', past: 'plastered', pp: 'plastered', s3: 'plasters' },
  { agentIcon: '🧑‍🔧', agentNoun: 'the mechanic', objectIcon: '🚗', objectNoun: 'the engine', objectPlural: false, base: 'tune', past: 'tuned', pp: 'tuned', s3: 'tunes' },
  { agentIcon: '🧑‍🎨', agentNoun: 'the artist', objectIcon: '🗿', objectNoun: 'the statue', objectPlural: false, base: 'sculpt', past: 'sculpted', pp: 'sculpted', s3: 'sculpts' },
  { agentIcon: '🧑‍🍳', agentNoun: 'the baker', objectIcon: '🥐', objectNoun: 'the croissants', objectPlural: true, base: 'glaze', past: 'glazed', pp: 'glazed', s3: 'glazes' },
  { agentIcon: '🧑‍⚕️', agentNoun: 'the nurse', objectIcon: '🩹', objectNoun: 'the wound', objectPlural: false, base: 'dress', past: 'dressed', pp: 'dressed', s3: 'dresses' },
  { agentIcon: '👩‍🚒', agentNoun: 'the firefighters', objectIcon: '🔥', objectNoun: 'the fire', objectPlural: false, base: 'douse', past: 'doused', pp: 'doused', s3: 'douses' },
  { agentIcon: '🧑‍💼', agentNoun: 'the secretary', objectIcon: '📠', objectNoun: 'the fax', objectPlural: false, base: 'send', past: 'sent', pp: 'sent', s3: 'sends' },
  { agentIcon: '🧑‍🏭', agentNoun: 'the factory workers', objectIcon: '📦', objectNoun: 'the boxes', objectPlural: true, base: 'seal', past: 'sealed', pp: 'sealed', s3: 'seals' },
  { agentIcon: '🧑‍🚀', agentNoun: 'the astronauts', objectIcon: '🛰️', objectNoun: 'the satellite', objectPlural: false, base: 'deploy', past: 'deployed', pp: 'deployed', s3: 'deploys' },
  { agentIcon: '🧑‍🎤', agentNoun: 'the band', objectIcon: '🎶', objectNoun: 'the song', objectPlural: false, base: 'record', past: 'recorded', pp: 'recorded', s3: 'records' },
  { agentIcon: '🧑‍🌾', agentNoun: 'the gardener', objectIcon: '🌹', objectNoun: 'the roses', objectPlural: true, base: 'clip', past: 'clipped', pp: 'clipped', s3: 'clips' },
  { agentIcon: '🧑‍🍼', agentNoun: 'the babysitter', objectIcon: '🍼', objectNoun: 'the baby', objectPlural: false, base: 'feed', past: 'fed', pp: 'fed', s3: 'feeds' },
  { agentIcon: '🧑‍🏫', agentNoun: 'the professor', objectIcon: '📊', objectNoun: 'the data', objectPlural: true, base: 'analyze', past: 'analyzed', pp: 'analyzed', s3: 'analyzes' },
  { agentIcon: '🧑‍💻', agentNoun: 'the programmer', objectIcon: '🐛', objectNoun: 'the bug', objectPlural: false, base: 'fix', past: 'fixed', pp: 'fixed', s3: 'fixes' },
  { agentIcon: '🧑‍⚖️', agentNoun: 'the judge', objectIcon: '⚖️', objectNoun: 'the case', objectPlural: false, base: 'review', past: 'reviewed', pp: 'reviewed', s3: 'reviews' },
  { agentIcon: '🧑‍🔬', agentNoun: 'the scientist', objectIcon: '🧪', objectNoun: 'the sample', objectPlural: false, base: 'test', past: 'tested', pp: 'tested', s3: 'tests' },
  { agentIcon: '🧑‍✈️', agentNoun: 'the pilot', objectIcon: '✈️', objectNoun: 'the plane', objectPlural: false, base: 'land', past: 'landed', pp: 'landed', s3: 'lands' },
  { agentIcon: '🧑‍🚀', agentNoun: 'the crew', objectIcon: '🚀', objectNoun: 'the rocket', objectPlural: false, base: 'refuel', past: 'refueled', pp: 'refueled', s3: 'refuels' },
  { agentIcon: '🧑‍🎨', agentNoun: 'the muralist', objectIcon: '🎨', objectNoun: 'the mural', objectPlural: false, base: 'paint', past: 'painted', pp: 'painted', s3: 'paints' },
  { agentIcon: '🧑‍🏭', agentNoun: 'the potter', objectIcon: '🏺', objectNoun: 'the vase', objectPlural: false, base: 'glaze', past: 'glazed', pp: 'glazed', s3: 'glazes' },
  { agentIcon: '👩‍🌾', agentNoun: 'the beekeeper', objectIcon: '🍯', objectNoun: 'the honey', objectPlural: false, base: 'extract', past: 'extracted', pp: 'extracted', s3: 'extracts' },
  { agentIcon: '🧑‍🔧', agentNoun: 'the plumber', objectIcon: '🚿', objectNoun: 'the pipes', objectPlural: true, base: 'replace', past: 'replaced', pp: 'replaced', s3: 'replaces' },
  { agentIcon: '🧑‍🎓', agentNoun: 'the students', objectIcon: '🔬', objectNoun: 'the experiment', objectPlural: false, base: 'conduct', past: 'conducted', pp: 'conducted', s3: 'conducts' },
  { agentIcon: '👩‍🍳', agentNoun: 'the cooks', objectIcon: '🍜', objectNoun: 'the noodles', objectPlural: true, base: 'boil', past: 'boiled', pp: 'boiled', s3: 'boils' },
  { agentIcon: '🧑‍🎨', agentNoun: 'the designer', objectIcon: '👗', objectNoun: 'the dress', objectPlural: false, base: 'tailor', past: 'tailored', pp: 'tailored', s3: 'tailors' },
  { agentIcon: '🧑‍🔧', agentNoun: 'the technician', objectIcon: '📺', objectNoun: 'the television', objectPlural: false, base: 'repair', past: 'repaired', pp: 'repaired', s3: 'repairs' },
  { agentIcon: '🧑‍🌾', agentNoun: 'the vintners', objectIcon: '🍇', objectNoun: 'the grapes', objectPlural: true, base: 'press', past: 'pressed', pp: 'pressed', s3: 'presses' },
  { agentIcon: '🧑‍🚒', agentNoun: 'the inspector', objectIcon: '🚪', objectNoun: 'the exits', objectPlural: true, base: 'inspect', past: 'inspected', pp: 'inspected', s3: 'inspects' },
  { agentIcon: '🧑‍💼', agentNoun: 'the auditors', objectIcon: '💼', objectNoun: 'the accounts', objectPlural: true, base: 'audit', past: 'audited', pp: 'audited', s3: 'audits' },
  { agentIcon: '🧑‍🏫', agentNoun: 'the trainer', objectIcon: '🏃', objectNoun: 'the athletes', objectPlural: true, base: 'motivate', past: 'motivated', pp: 'motivated', s3: 'motivates' },
  { agentIcon: '👩‍🎤', agentNoun: 'the choir', objectIcon: '🎵', objectNoun: 'the anthem', objectPlural: false, base: 'perform', past: 'performed', pp: 'performed', s3: 'performs' },
  { agentIcon: '🧑‍🎨', agentNoun: 'the illustrator', objectIcon: '📔', objectNoun: 'the comic book', objectPlural: false, base: 'illustrate', past: 'illustrated', pp: 'illustrated', s3: 'illustrates' },
  { agentIcon: '🧑‍🔧', agentNoun: 'the electrician', objectIcon: '🔘', objectNoun: 'the circuit breaker', objectPlural: false, base: 'test', past: 'tested', pp: 'tested', s3: 'tests' },
  { agentIcon: '🧑‍🍳', agentNoun: 'the chef', objectIcon: '🥩', objectNoun: 'the steak', objectPlural: false, base: 'grill', past: 'grilled', pp: 'grilled', s3: 'grills' },
  { agentIcon: '🧑‍🌾', agentNoun: 'the shepherd', objectIcon: '🐑', objectNoun: 'the sheep', objectPlural: true, base: 'shear', past: 'sheared', pp: 'sheared', s3: 'shears' },
  { agentIcon: '🧑‍🔬', agentNoun: 'the vet', objectIcon: '🐕', objectNoun: 'the dog', objectPlural: false, base: 'vaccinate', past: 'vaccinated', pp: 'vaccinated', s3: 'vaccinates' },
  { agentIcon: '🧑‍🏭', agentNoun: 'the printer operator', objectIcon: '📰', objectNoun: 'the newspaper', objectPlural: false, base: 'print', past: 'printed', pp: 'printed', s3: 'prints' },
  { agentIcon: '🧑‍🎨', agentNoun: 'the calligrapher', objectIcon: '✒️', objectNoun: 'the invitation', objectPlural: false, base: 'write', past: 'wrote', pp: 'written', s3: 'writes' },
  { agentIcon: '🧑‍💻', agentNoun: 'the editor', objectIcon: '🎬', objectNoun: 'the footage', objectPlural: false, base: 'edit', past: 'edited', pp: 'edited', s3: 'edits' },
  { agentIcon: '🧑‍🚀', agentNoun: 'the engineer', objectIcon: '🛠️', objectNoun: 'the machine', objectPlural: false, base: 'calibrate', past: 'calibrated', pp: 'calibrated', s3: 'calibrates' },
  { agentIcon: '🧑‍🎨', agentNoun: 'the framers', objectIcon: '🖼️', objectNoun: 'the paintings', objectPlural: true, base: 'frame', past: 'framed', pp: 'framed', s3: 'frames' },
  { agentIcon: '🧑‍🔧', agentNoun: 'the locksmith', objectIcon: '🔑', objectNoun: 'the lock', objectPlural: false, base: 'replace', past: 'replaced', pp: 'replaced', s3: 'replaces' },
  { agentIcon: '🧑‍🌾', agentNoun: 'the fisherman', objectIcon: '🐟', objectNoun: 'the fish', objectPlural: true, base: 'weigh', past: 'weighed', pp: 'weighed', s3: 'weighs' },
  { agentIcon: '🧑‍🍳', agentNoun: 'the barista', objectIcon: '🎨', objectNoun: 'the latte art', objectPlural: false, base: 'pour', past: 'poured', pp: 'poured', s3: 'pours' },
  { agentIcon: '🧑‍🏫', agentNoun: 'the librarian', objectIcon: '📚', objectNoun: 'the books', objectPlural: true, base: 'catalog', past: 'cataloged', pp: 'cataloged', s3: 'catalogs' },
  { agentIcon: '🧑‍🔬', agentNoun: 'the researchers', objectIcon: '🦠', objectNoun: 'the virus', objectPlural: false, base: 'study', past: 'studied', pp: 'studied', s3: 'studies' },
  { agentIcon: '🧑‍🎨', agentNoun: 'the jeweler', objectIcon: '💎', objectNoun: 'the gemstone', objectPlural: false, base: 'cut', past: 'cut', pp: 'cut', s3: 'cuts' },
...
const REPORTED_TEMPLATES = [
  ...
  // ----- Bổ sung vòng mục tiêu 1150 -----
  { kind: 'am-adj', icon: '🍽️', rest: 'famished', quote: '"I am famished."' },
  { kind: 'am-adj', icon: '🥶', rest: 'chilly', quote: '"I am chilly."' },
  { kind: 'am-adj', icon: '😒', rest: 'envious', quote: '"I am envious."' },
  { kind: 'am-adj', icon: '😲', rest: 'startled', quote: '"I am startled."' },
  { kind: 'am-adj', icon: '😳', rest: 'flustered', quote: '"I am flustered."' },
  { kind: 'am-adj', icon: '😌', rest: 'carefree', quote: '"I am carefree."' },
  { kind: 'am-adj', icon: '🤨', rest: 'wary', quote: '"I am wary."' },
  { kind: 'am-adj', icon: '😞', rest: 'gloomy', quote: '"I am gloomy."' },
  { kind: 'am-adj', icon: '💪', rest: 'invincible', quote: '"I am invincible."' },
  { kind: 'am-adj', icon: '😪', rest: 'sluggish', quote: '"I am sluggish."' },
  { kind: 'am-adj', icon: '😬', rest: 'jittery', quote: '"I am jittery."' },
  { kind: 'am-adj', icon: '😇', rest: 'serene', quote: '"I am serene."' },
  { kind: 'am-adj', icon: '😤', rest: 'vindicated', quote: '"I am vindicated."' },
  { kind: 'am-ving', icon: '🏆', rest: 'polishing the trophy', quote: '"I am polishing the trophy."' },
  { kind: 'am-ving', icon: '♻️', rest: 'sorting the recycling', quote: '"I am sorting the recycling."' },
  { kind: 'am-ving', icon: '🪴', rest: 'watering the balcony plants', quote: '"I am watering the balcony plants."' },
  { kind: 'am-ving', icon: '🌡️', rest: 'adjusting the thermostat', quote: '"I am adjusting the thermostat."' },
  { kind: 'am-ving', icon: '🏷️', rest: 'labeling the spice jars', quote: '"I am labeling the spice jars."' },
  { kind: 'am-ving', icon: '🎧', rest: 'untangling the headphones', quote: '"I am untangling the headphones."' },
  { kind: 'am-ving', icon: '🚗', rest: 'buffing the car', quote: '"I am buffing the car."' },
  { kind: 'am-ving', icon: '🚪', rest: 'reorganizing the closet', quote: '"I am reorganizing the closet."' },
  { kind: 'am-ving', icon: '🎨', rest: 'priming the wall', quote: '"I am priming the wall."' },
  { kind: 'am-ving', icon: '🔪', rest: 'sharpening the kitchen knives', quote: '"I am sharpening the kitchen knives."' },
  { kind: 'am-ving', icon: '🎸', rest: 'restringing the guitar', quote: '"I am restringing the guitar."' },
  { kind: 'am-ving', icon: '⛺', rest: 'patching the tent', quote: '"I am patching the tent."' },
  { kind: 'am-ving', icon: '🚲', rest: 'greasing the bike chain', quote: '"I am greasing the bike chain."' },
  { kind: 'present-verb', icon: '🌇', past: 'admired', s3: 'admires', rest: 'the sunset', quote: '"I admire the sunset."' },
  { kind: 'present-verb', icon: '🙏', past: 'appreciated', s3: 'appreciates', rest: 'small gestures', quote: '"I appreciate small gestures."' },
  { kind: 'present-verb', icon: '🤥', past: 'despised', s3: 'despises', rest: 'liars', quote: '"I despise liars."' },
  { kind: 'present-verb', icon: '🎁', past: 'anticipated', s3: 'anticipates', rest: 'a big surprise', quote: '"I anticipate a big surprise."' },
  { kind: 'present-verb', icon: '🤔', past: 'questioned', s3: 'questions', rest: 'his motives', quote: '"I question his motives."' },
  { kind: 'present-verb', icon: '🍲', past: 'trusted', s3: 'trusts', rest: 'this recipe completely', quote: '"I trust this recipe completely."' },
  { kind: 'present-verb', icon: '😤', past: 'resented', s3: 'resents', rest: 'unfair criticism', quote: '"I resent unfair criticism."' },
  { kind: 'present-verb', icon: '🏔️', past: 'feared', s3: 'fears', rest: 'heights', quote: '"I fear heights."' },
  { kind: 'present-verb', icon: '🏫', past: 'missed', s3: 'misses', rest: 'my old school', quote: '"I miss my old school."' },
  { kind: 'present-verb', icon: '😮‍💨', past: 'needed', s3: 'needs', rest: 'a short break', quote: '"I need a short break."' },
  { kind: 'present-verb', icon: '🌟', past: 'believed', s3: 'believes', rest: 'in second chances', quote: '"I believe in second chances."' },
  { kind: 'present-verb', icon: '📋', past: 'understood', s3: 'understands', rest: 'the assignment now', quote: '"I understand the assignment now."' },
  { kind: 'present-verb', icon: '☀️', past: 'remembered', s3: 'remembers', rest: 'that summer well', quote: '"I remember that summer well."' },
  { kind: 'will', icon: '🪴', rest: 'water the office ferns', quote: '"I will water the office ferns."' },
  { kind: 'will', icon: '🥩', rest: 'defrost the meat tonight', quote: '"I will defrost the meat tonight."' },
  { kind: 'will', icon: '🍽️', rest: 'iron the tablecloth', quote: '"I will iron the tablecloth."' },
  { kind: 'will', icon: '✉️', rest: 'seal the envelope', quote: '"I will seal the envelope."' },
  { kind: 'will', icon: '🧂', rest: 'label the spice jars', quote: '"I will label the spice jars."' },
  { kind: 'will', icon: '🏆', rest: 'polish the silver trophy', quote: '"I will polish the silver trophy."' },
  { kind: 'will', icon: '🧰', rest: 'organize the toolbox', quote: '"I will organize the toolbox."' },
  { kind: 'will', icon: '📋', rest: 'update the guest list', quote: '"I will update the guest list."' },
  { kind: 'will', icon: '🏙️', rest: 'water the rooftop garden', quote: '"I will water the rooftop garden."' },
  { kind: 'will', icon: '📬', rest: 'repaint the mailbox', quote: '"I will repaint the mailbox."' },
  { kind: 'will', icon: '🧊', rest: 'restock the fridge', quote: '"I will restock the fridge."' },
  { kind: 'will', icon: '🔩', rest: 'tighten the loose screws', quote: '"I will tighten the loose screws."' },
  { kind: 'will', icon: '🧹', rest: 'sweep the garage floor', quote: '"I will sweep the garage floor."' },
  { kind: 'can', icon: '🚲', rest: 'unicycle backwards', quote: '"I can unicycle backwards."' },
  { kind: 'can', icon: '🧩', rest: "solve a Rubik's cube blindfolded", quote: '"I can solve a Rubik\'s cube blindfolded."' },
  { kind: 'can', icon: '🧪', rest: 'recite the periodic table', quote: '"I can recite the periodic table."' },
  { kind: 'can', icon: '😗', rest: 'whistle two notes at once', quote: '"I can whistle two notes at once."' },
  { kind: 'can', icon: '🤸', rest: 'walk on my hands', quote: '"I can walk on my hands."' },
  { kind: 'can', icon: '🃏', rest: 'build a card tower', quote: '"I can build a card tower."' },
  { kind: 'can', icon: '📖', rest: 'read upside down', quote: '"I can read upside down."' },
  { kind: 'can', icon: '🗣️', rest: 'imitate five different accents', quote: '"I can imitate five different accents."' },
  { kind: 'can', icon: '🕊️', rest: 'fold an origami crane in a minute', quote: '"I can fold an origami crane in a minute."' },
  { kind: 'can', icon: '🌍', rest: "name every country's capital", quote: '"I can name every country\'s capital."' },
  { kind: 'can', icon: '🎡', rest: 'hula hoop for ten minutes', quote: '"I can hula hoop for ten minutes."' },
  { kind: 'can', icon: '🔥', rest: 'juggle flaming torches', quote: '"I can juggle flaming torches."' },
  { kind: 'can', icon: '🖊️', rest: 'sketch a portrait in five minutes', quote: '"I can sketch a portrait in five minutes."' },
  { kind: 'have-pp', icon: '🗄️', rest: 'reorganized the pantry shelves', quote: '"I have reorganized the pantry shelves."' },
  { kind: 'have-pp', icon: '🪴', rest: 'watered the balcony flowers', quote: '"I have watered the balcony flowers."' },
  { kind: 'have-pp', icon: '🪑', rest: 'repaired the broken chair', quote: '"I have repaired the broken chair."' },
  { kind: 'have-pp', icon: '🎂', rest: 'finished decorating the cake', quote: '"I have finished decorating the cake."' },
  { kind: 'have-pp', icon: '🧹', rest: 'cleaned out the garage', quote: '"I have cleaned out the garage."' },
  { kind: 'have-pp', icon: '📄', rest: 'updated my resume', quote: '"I have updated my resume."' },
  { kind: 'have-pp', icon: '📝', rest: 'submitted the permission slip', quote: '"I have submitted the permission slip."' },
  { kind: 'have-pp', icon: '📷', rest: 'charged the camera battery', quote: '"I have charged the camera battery."' },
  { kind: 'have-pp', icon: '🖼️', rest: 'framed the family photo', quote: '"I have framed the family photo."' },
  { kind: 'have-pp', icon: '📚', rest: 'organized the bookshelf', quote: '"I have organized the bookshelf."' },
  { kind: 'have-pp', icon: '🎣', rest: 'mended the fishing net', quote: '"I have mended the fishing net."' },
  { kind: 'have-pp', icon: '🩹', rest: 'restocked the first-aid kit', quote: '"I have restocked the first-aid kit."' },
  { kind: 'have-pp', icon: '🧺', rest: 'packed the picnic basket', quote: '"I have packed the picnic basket."' },
];
...
export const QUANTIFIER_NOUNS = [
  ...
  // ----- Bổ sung vòng mục tiêu 1150 -----
  { emoji: '🎴', plural: 'dragonflies' },
  { emoji: '🩰', plural: 'grasshoppers' },
  { emoji: '🥅', plural: 'fireflies' },
  { emoji: '🏑', plural: 'moths' },
  { emoji: '🛤️', plural: 'centipedes' },
  { emoji: '🛬', plural: 'beetles' },
  { emoji: '🛫', plural: 'seahorses' },
  { emoji: '🛩️', plural: 'starfish' },
  { emoji: '🚊', plural: 'sea urchins' },
  { emoji: '🚆', plural: 'sea turtles' },
  { emoji: '🚄', plural: 'manta rays' },
  { emoji: '🚅', plural: 'eels' },
  { emoji: '🚈', plural: 'macarons' },
  { emoji: '🚉', plural: 'tiramisu cups' },
  { emoji: '⚓', plural: 'gelato scoops' },
  { emoji: '🪝', plural: 'churros' },
  { emoji: '🗺️', plural: 'brownies' },
  { emoji: '🏕️', plural: 'marshmallows' },
  { emoji: '🏖️', plural: 'gummy bears' },
  { emoji: '🏗️', plural: 'jellybeans' },
  { emoji: '🪵', plural: 'omelettes' },
  { emoji: '🛖', plural: 'yogurt cups' },
  { emoji: '🏚️', plural: 'granola bars' },
  { emoji: '🏙️', plural: 'toast slices' },
  { emoji: '🌆', plural: 'cereal bowls' },
  { emoji: '🌇', plural: 'levels' },
  { emoji: '🌉', plural: 'chisels' },
  { emoji: '🎑', plural: 'clamps' },
  { emoji: '🏮', plural: 'staple guns' },
  { emoji: '✨', plural: 'tape measures' },
  { emoji: '🎖️', plural: 'drills' },
  { emoji: '📝', plural: 'raincoats' },
  { emoji: '💼', plural: 'ponchos' },
  { emoji: '📁', plural: 'mittens' },
  { emoji: '📂', plural: 'earmuffs' },
  { emoji: '🗂️', plural: 'bow ties' },
  { emoji: '🗞️', plural: 'safety vests' },
  { emoji: '📰', plural: 'aprons' },
  { emoji: '📚', plural: 'bandanas' },
  { emoji: '🔖', plural: 'xylophones' },
  { emoji: '🗄️', plural: 'tambourines' },
  { emoji: '🔏', plural: 'cellos' },
  { emoji: '🔐', plural: 'harps' },
  { emoji: '⚒️', plural: 'ukuleles' },
  { emoji: '🛠️', plural: 'castanets' },
  { emoji: '📡', plural: 'protractors' },
  { emoji: '🛢️', plural: 'erasers' },
  { emoji: '💸', plural: 'highlighters' },
  { emoji: '💳', plural: 'binders' },
  { emoji: '💎', plural: 'staplers' },
  { emoji: '⚖️', plural: 'hole punchers' },
  { emoji: '🧪', plural: 'constellations' },
  { emoji: '🧼', plural: 'asteroids' },
  { emoji: '🚽', plural: 'space shuttles' },
  { emoji: '🛀', plural: 'space stations' },
  { emoji: '🪅', plural: 'meteor showers' },
  { emoji: '🪩', plural: 'hailstones' },
  { emoji: '🪄', plural: 'sunbeams' },
  { emoji: '🪦', plural: 'dew drops' },
  { emoji: '🏺', plural: 'frost patterns' },
  { emoji: '🦺', plural: 'heat waves' },
  { emoji: '👖', plural: 'toy soldiers' },
  { emoji: '🩲', plural: 'spinning tops' },
  { emoji: '👚', plural: 'marbles' },
  { emoji: '👛', plural: 'jump ropes' },
  { emoji: '💄', plural: 'pinwheels' },
  { emoji: '🥑', plural: 'kaleidoscopes' },
  { emoji: '🍞', plural: 'hot air balloons' },
  { emoji: '🥖', plural: 'zeppelins' },
  { emoji: '🍖', plural: 'jet skis' },
  { emoji: '🦴', plural: 'snowmobiles' },
  { emoji: '🥘', plural: 'golf carts' },
  { emoji: '🫕', plural: 'forklifts' },
  { emoji: '🥫', plural: 'construction cranes' },
  { emoji: '🍲', plural: 'hummingbirds' },
  { emoji: '🍱', plural: 'woodpeckers' },
  { emoji: '🍚', plural: 'toucans' },
  { emoji: '🍘', plural: 'storks' },
  { emoji: '🐽', plural: 'herons' },
  { emoji: '🙈', plural: 'pelicans' },
  { emoji: '🙉', plural: 'kingfishers' },
  { emoji: '🙊', plural: 'chameleons' },
  { emoji: '🐒', plural: 'iguanas' },
  { emoji: '🐦', plural: 'geckos' },
  { emoji: '🐤', plural: 'salamanders' },
  { emoji: '🐣', plural: 'newts' },
  { emoji: '🐥', plural: 'bamboo stalks' },
  { emoji: '🪲', plural: 'ferns' },
  { emoji: '🦍', plural: 'mosses' },
  { emoji: '🦧', plural: 'vines' },
  { emoji: '🐪', plural: 'orchids' },
  { emoji: '🐕', plural: 'bonsai trees' },
  { emoji: '🦮', plural: 'succulents' },
  { emoji: '🪶', plural: 'lighthouses' },
  { emoji: '🕊️', plural: 'arenas' },
  { emoji: '🏉', plural: 'castles on the hill' },
  { emoji: '🎿', plural: 'fountains' },
  { emoji: '⛷️', plural: 'huts' },
  { emoji: '🤼', plural: 'abandoned houses' },
  { emoji: '🤸', plural: 'monuments' },
  { emoji: '⛹️', plural: 'liberty statues' },
  { emoji: '🤺', plural: 'circus tents' },
  { emoji: '🤾', plural: 'playground slides' },
  { emoji: '🏌️', plural: 'carousels' },
  { emoji: '🏇', plural: 'roller coaster cars' },
  { emoji: '🧘', plural: 'roller skates for kids' },
  { emoji: '🏊', plural: 'flying discs for dogs' },
  { emoji: '🤽', plural: 'shuttlecocks' },
  { emoji: '🚣', plural: 'bowling balls' },
  { emoji: '🧗', plural: 'figure skates' },
  { emoji: '🚵', plural: 'curling brooms' },
  { emoji: '🚴', plural: 'kayaks' },
  { emoji: '💦', plural: 'rowboats' },
  { emoji: '🕳️', plural: 'crossbows' },
  { emoji: '🍂', plural: 'karate belts' },
  { emoji: '🍃', plural: 'snorkel masks' },
  { emoji: '🌎', plural: 'one-piece swimsuits' },
  { emoji: '🌏', plural: 'two-piece swimsuits' },
  { emoji: '🗾', plural: 'work boots' },
  { emoji: '🪧', plural: 'thong sandals' },
  { emoji: '🚏', plural: 'silk robes' },
  { emoji: '🛣️', plural: 'wedding sarees' },
  { emoji: '🗿', plural: 'army helmets' },
  { emoji: '🎪', plural: 'straw hats' },
  { emoji: '🎭', plural: 'top hats' },
  { emoji: '📱', plural: 'trucker caps' },
  { emoji: '🖲️', plural: 'royal crowns' },
  { emoji: '💽', plural: 'lipstick tubes' },
  { emoji: '💾', plural: 'nail polish bottles' },
  { emoji: '💿', plural: 'face masks for skin' },
  { emoji: '📀', plural: 'spare toothbrushes' },
  { emoji: '🎥', plural: 'paper towel rolls' },
  { emoji: '📽️', plural: 'mop buckets' },
  { emoji: '📺', plural: 'garden brooms' },
  { emoji: '📸', plural: 'spare razors' },
  { emoji: '📼', plural: 'bathtub toys' },
  { emoji: '🔍', plural: 'water fountains' },
  { emoji: '🔎', plural: 'hand mirrors' },
  { emoji: '📃', plural: 'photo frames' },
  { emoji: '📜', plural: 'grandfather clocks' },
  { emoji: '📄', plural: 'oil lamps for prayer' },
  { emoji: '📑', plural: 'lucky charms' },
  { emoji: '🏷️', plural: 'disco balls' },
  { emoji: '🧾', plural: 'sparkling fireworks' },
  { emoji: '✉️', plural: 'party firecrackers' },
  { emoji: '📧', plural: 'paper lanterns' },
  { emoji: '📨', plural: 'cuckoo clocks' },
  { emoji: '📩', plural: 'snow globes' },
  { emoji: '📤', plural: 'knitting needles' },
...
export const POS_WORDS = [
  ...
  // ----- Bổ sung vòng mục tiêu 1150 -----
  { sentence: 'The team received public recognition for their work.', word: 'recognition', pos: 'noun', hint: 'đuôi "-tion" biến động từ "recognize" thành danh từ chỉ sự công nhận.' },
  { sentence: 'Her face showed pure amazement.', word: 'amazement', pos: 'noun', hint: 'đuôi "-ment" biến động từ "amaze" thành danh từ chỉ trạng thái ngạc nhiên.' },
  { sentence: 'He solved the puzzle with surprising cleverness.', word: 'cleverness', pos: 'noun', hint: 'đuôi "-ness" biến tính từ "clever" thành danh từ chỉ tính chất.' },
  { sentence: 'The artist is known for her creativity.', word: 'creativity', pos: 'noun', hint: 'đuôi "-ity" biến tính từ "creative" thành danh từ trừu tượng.' },
  { sentence: 'The two companies formed a new partnership.', word: 'partnership', pos: 'noun', hint: 'đuôi "-ship" biến danh từ "partner" thành danh từ chỉ mối quan hệ.' },
  { sentence: 'She is looking forward to adulthood.', word: 'adulthood', pos: 'noun', hint: 'đuôi "-hood" biến danh từ "adult" thành danh từ chỉ giai đoạn/trạng thái.' },
  { sentence: 'The teacher offered guidance to new students.', word: 'guidance', pos: 'noun', hint: 'đuôi "-ance" biến động từ "guide" thành danh từ chỉ sự hướng dẫn.' },
  { sentence: 'The chef is famous for culinary excellence.', word: 'excellence', pos: 'noun', hint: 'đuôi "-ence" biến tính từ "excellent" thành danh từ chỉ sự xuất sắc.' },
  { sentence: 'The runner crossed the finish line first.', word: 'runner', pos: 'noun', hint: 'đuôi "-er" biến động từ "run" thành danh từ chỉ người thực hiện hành động.' },
  { sentence: 'The collector displayed rare stamps.', word: 'collector', pos: 'noun', hint: 'đuôi "-or" biến động từ "collect" thành danh từ chỉ người thực hiện hành động.' },
  { sentence: 'She studied journalism at university.', word: 'journalism', pos: 'noun', hint: 'đuôi "-ism" biến danh từ thành danh từ chỉ ngành nghề.' },
  { sentence: 'The singer rose to stardom overnight.', word: 'stardom', pos: 'noun', hint: 'đuôi "-dom" biến danh từ "star" thành danh từ chỉ trạng thái/địa vị.' },
  { sentence: 'The firefighter was praised for his bravery.', word: 'bravery', pos: 'noun', hint: 'đuôi "-ery" biến tính từ "brave" thành danh từ chỉ phẩm chất.' },
  { sentence: 'Please provide your signature at the bottom.', word: 'signature', pos: 'noun', hint: 'đuôi "-ture" biến động từ "sign" thành danh từ.' },
  { sentence: 'The family inherited great wealth.', word: 'wealth', pos: 'noun', hint: 'danh từ chỉ sự giàu có — không có đuôi cố định, nhận diện qua vai trò làm tân ngữ chỉ khái niệm.' },
  { sentence: 'He forgot to pay the postage for the letter.', word: 'postage', pos: 'noun', hint: 'đuôi "-age" biến danh từ "post" thành danh từ chỉ cước phí.' },
  { sentence: 'The librarian helped me find the book.', word: 'librarian', pos: 'noun', hint: 'đuôi "-ian" biến danh từ "library" thành danh từ chỉ người làm nghề liên quan.' },
  { sentence: 'The prisoners suffered great cruelty.', word: 'cruelty', pos: 'noun', hint: 'đuôi "-ty" biến tính từ "cruel" thành danh từ chỉ tính chất.' },
  { sentence: 'Her insistence on honesty surprised everyone.', word: 'insistence', pos: 'noun', hint: 'đuôi "-ence" biến động từ "insist" thành danh từ chỉ sự khăng khăng.' },
  { sentence: 'These vitamins will energize your body.', word: 'energize', pos: 'verb', hint: 'đuôi "-ize" biến danh từ "energy" thành động từ.' },
  { sentence: 'New wires will electrify the old house.', word: 'electrify', pos: 'verb', hint: 'đuôi "-ify" biến danh từ "electric" thành động từ.' },
  { sentence: 'Good news will quicken her pace.', word: 'quicken', pos: 'verb', hint: 'đuôi "-en" biến tính từ "quick" thành động từ.' },
  { sentence: 'Please unfold the map on the table.', word: 'unfold', pos: 'verb', hint: 'tiền tố "un-" biến động từ "fold" thành động từ nghĩa ngược lại.' },
  { sentence: 'The artist decided to redraw the sketch.', word: 'redraw', pos: 'verb', hint: 'tiền tố "re-" biến động từ "draw" thành động từ nghĩa "làm lại".' },
  { sentence: 'The manager will disallow late submissions.', word: 'disallow', pos: 'verb', hint: 'tiền tố "dis-" biến động từ "allow" thành động từ mang nghĩa phủ định.' },
  { sentence: 'The report seemed to misinform the public.', word: 'misinform', pos: 'verb', hint: 'tiền tố "mis-" biến động từ "inform" thành động từ nghĩa "sai lệch".' },
  { sentence: 'The new bridge will interconnect the two islands.', word: 'interconnect', pos: 'verb', hint: 'tiền tố "inter-" biến động từ "connect" thành động từ nghĩa "kết nối qua lại".' },
  { sentence: 'She trained hard to outrun her rivals.', word: 'outrun', pos: 'verb', hint: 'tiền tố "out-" biến động từ "run" thành động từ nghĩa "vượt qua".' },
  { sentence: 'Workers will uproot the old tree stump.', word: 'uproot', pos: 'verb', hint: 'tiền tố "up-" kết hợp danh từ "root" thành động từ nghĩa "nhổ bật rễ".' },
  { sentence: 'The coach tried to downplay the injury.', word: 'downplay', pos: 'verb', hint: 'tiền tố "down-" biến động từ "play" thành động từ nghĩa "giảm nhẹ".' },
  { sentence: 'The strange noise began to bewilder the guests.', word: 'bewilder', pos: 'verb', hint: 'tiền tố "be-" tạo động từ nghĩa "làm bối rối", giống mẫu "befriend/belittle".' },
  { sentence: 'The visiting fans began to outnumber the home fans.', word: 'outnumber', pos: 'verb', hint: 'tiền tố "out-" biến động từ "number" thành động từ nghĩa "vượt trội về số lượng".' },
  { sentence: "Don't overdo the seasoning in the soup.", word: 'overdo', pos: 'verb', hint: 'tiền tố "over-" biến động từ "do" thành động từ nghĩa "làm quá mức".' },
  { sentence: 'Never underestimate a determined child.', word: 'underestimate', pos: 'verb', hint: 'tiền tố "under-" biến động từ "estimate" thành động từ nghĩa "đánh giá thấp".' },
  { sentence: 'Please recharge the batteries overnight.', word: 'recharge', pos: 'verb', hint: 'tiền tố "re-" biến động từ "charge" thành động từ nghĩa "làm lại".' },
  { sentence: 'Remember to unplug the iron before leaving.', word: 'unplug', pos: 'verb', hint: 'tiền tố "un-" biến động từ "plug" thành động từ mang nghĩa ngược lại.' },
  { sentence: 'The lecture aimed to enlighten young students.', word: 'enlighten', pos: 'verb', hint: 'tiền tố "en-" biến tính từ "light" thành động từ nghĩa "khai sáng".' },
  { sentence: 'The company wants to diversify its products.', word: 'diversify', pos: 'verb', hint: 'đuôi "-ify" biến tính từ "diverse" thành động từ.' },
  { sentence: 'The story felt colorless and dull.', word: 'colorless', pos: 'adjective', hint: 'đuôi "-less" biến danh từ "color" thành tính từ nghĩa "thiếu".' },
  { sentence: 'Their long search proved fruitless.', word: 'fruitless', pos: 'adjective', hint: 'đuôi "-less" biến danh từ "fruit" thành tính từ nghĩa "không có kết quả".' },
  { sentence: 'Spinach is a very nutritious vegetable.', word: 'nutritious', pos: 'adjective', hint: 'đuôi "-ous" biến danh từ "nutrition" thành tính từ.' },
  { sentence: 'She led an adventurous life.', word: 'adventurous', pos: 'adjective', hint: 'đuôi "-ous" biến danh từ "adventure" thành tính từ.' },
  { sentence: 'His persuasive speech won the debate.', word: 'persuasive', pos: 'adjective', hint: 'đuôi "-ive" biến động từ "persuade" thành tính từ.' },
  { sentence: 'The chemical reaction was highly explosive.', word: 'explosive', pos: 'adjective', hint: 'đuôi "-ive" biến động từ "explode" thành tính từ.' },
  { sentence: 'They live in a small coastal town.', word: 'coastal', pos: 'adjective', hint: 'đuôi "-al" biến danh từ "coast" thành tính từ.' },
  { sentence: 'The lyrics have a poetic quality.', word: 'poetic', pos: 'adjective', hint: 'đuôi "-ic" biến danh từ "poem/poet" thành tính từ.' },
  { sentence: 'The new phone is surprisingly affordable.', word: 'affordable', pos: 'adjective', hint: 'đuôi "-able" biến động từ "afford" thành tính từ.' },
  { sentence: 'The whisper was barely audible.', word: 'audible', pos: 'adjective', hint: 'đuôi "-ible" liên quan gốc "audio" thành tính từ nghĩa "nghe được".' },
  { sentence: 'My little sister is very chatty.', word: 'chatty', pos: 'adjective', hint: 'đuôi "-y" biến danh từ "chat" thành tính từ.' },
  { sentence: 'He has always been a bookish child.', word: 'bookish', pos: 'adjective', hint: 'đuôi "-ish" biến danh từ "book" thành tính từ nghĩa "có xu hướng như".' },
  { sentence: 'The fireworks display was truly awesome.', word: 'awesome', pos: 'adjective', hint: 'đuôi "-some" biến danh từ "awe" thành tính từ nghĩa "gây kinh ngạc".' },
  { sentence: 'The old ship was no longer seaworthy.', word: 'seaworthy', pos: 'adjective', hint: 'đuôi "-worthy" biến danh từ "sea" thành tính từ nghĩa "đủ điều kiện đi biển".' },
  { sentence: 'The vest is completely bulletproof.', word: 'bulletproof', pos: 'adjective', hint: 'đuôi "-proof" biến danh từ "bullet" thành tính từ nghĩa "chống lại được".' },
  { sentence: 'Her movements were graceful and birdlike.', word: 'birdlike', pos: 'adjective', hint: 'đuôi "-like" biến danh từ "bird" thành tính từ nghĩa "giống như".' },
  { sentence: 'Carrying all those bags was cumbersome.', word: 'cumbersome', pos: 'adjective', hint: 'đuôi "-some" biến động từ cổ "cumber" thành tính từ nghĩa "cồng kềnh".' },
  { sentence: 'The nurse was gentle and considerate.', word: 'considerate', pos: 'adjective', hint: 'đuôi "-ate" biến động từ "consider" thành tính từ nghĩa "chu đáo".' },
  { sentence: 'His excuse was simply not acceptable.', word: 'acceptable', pos: 'adjective', hint: 'đuôi "-able" biến động từ "accept" thành tính từ.' },
  { sentence: 'The dancer moved gracefully across the stage.', word: 'gracefully', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "graceful" thành trạng từ.' },
  { sentence: 'He approached the dog cautiously.', word: 'cautiously', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "cautious" thành trạng từ.' },
  { sentence: 'The wind howled furiously all night.', word: 'furiously', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "furious" thành trạng từ.' },
  { sentence: 'She generously shared her lunch.', word: 'generously', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "generous" thành trạng từ.' },
  { sentence: 'He deliberately ignored the warning.', word: 'deliberately', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "deliberate" thành trạng từ.' },
  { sentence: 'The numbers were chosen randomly.', word: 'randomly', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "random" thành trạng từ.' },
  { sentence: 'The alarm went off instantly.', word: 'instantly', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "instant" thành trạng từ.' },
  { sentence: 'The old car climbed the hill steadily.', word: 'steadily', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "steady" thành trạng từ.' },
  { sentence: 'The swimmer moved swiftly through the water.', word: 'swiftly', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "swift" thành trạng từ.' },
  { sentence: 'She wisely saved some money for later.', word: 'wisely', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "wise" thành trạng từ.' },
  { sentence: 'Please fold the paper properly.', word: 'properly', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "proper" thành trạng từ.' },
  { sentence: 'He answered every question correctly.', word: 'correctly', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "correct" thành trạng từ.' },
  { sentence: 'The address was written incorrectly.', word: 'incorrectly', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "incorrect" thành trạng từ.' },
  { sentence: 'The festival is held annually in spring.', word: 'annually', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "annual" thành trạng từ.' },
  { sentence: 'The nurse checks his temperature hourly.', word: 'hourly', pos: 'adverb', hint: 'đuôi "-ly" biến danh từ "hour" thành trạng từ.' },
  { sentence: 'She instinctively grabbed the falling cup.', word: 'instinctively', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "instinctive" thành trạng từ.' },
  { sentence: 'He reluctantly agreed to help.', word: 'reluctantly', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "reluctant" thành trạng từ.' },
  { sentence: 'The team urgently needed more supplies.', word: 'urgently', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "urgent" thành trạng từ.' },
  { sentence: 'The puppy waited eagerly by the door.', word: 'eagerly', pos: 'adverb', hint: 'đuôi "-ly" biến tính từ "eager" thành trạng từ.' },
  { sentence: 'The cat is hiding in the box.', word: 'in', pos: 'preposition', hint: 'giới từ chỉ vị trí bên trong, đứng trước danh từ "the box".' },
  { sentence: 'The cat is sleeping on the sofa.', word: 'on', pos: 'preposition', hint: 'giới từ chỉ vị trí bề mặt, đứng trước danh từ "the sofa".' },
  { sentence: 'The ball rolled under the bed.', word: 'under', pos: 'preposition', hint: 'giới từ chỉ vị trí bên dưới, đứng trước danh từ "the bed".' },
  { sentence: 'The path runs between the two lakes.', word: 'between', pos: 'preposition', hint: 'giới từ chỉ vị trí ở giữa 2 đối tượng.' },
  { sentence: 'He parked his bike beside the fence.', word: 'beside', pos: 'preposition', hint: 'giới từ chỉ vị trí bên cạnh, đứng trước danh từ "the fence".' },
  { sentence: 'They stayed quiet during the movie.', word: 'during', pos: 'preposition', hint: 'giới từ chỉ thời gian diễn ra trong suốt.' },
  { sentence: 'Wash your hands before dinner.', word: 'before', pos: 'preposition', hint: 'giới từ chỉ thời gian trước, đứng trước danh từ "dinner".' },
  { sentence: 'We will play after school.', word: 'after', pos: 'preposition', hint: 'giới từ chỉ thời gian sau, đứng trước danh từ "school".' },
  { sentence: 'The train passed through the tunnel.', word: 'through', pos: 'preposition', hint: 'giới từ chỉ chuyển động xuyên qua.' },
  { sentence: 'He left without his umbrella.', word: 'without', pos: 'preposition', hint: 'giới từ chỉ sự thiếu vắng, đứng trước danh từ "his umbrella".' },
  { sentence: 'A plane flew above the clouds.', word: 'above', pos: 'preposition', hint: 'giới từ chỉ vị trí phía trên, đứng trước danh từ "the clouds".' },
  { sentence: 'A shadow moved slowly across the wall.', word: 'across', pos: 'preposition', hint: 'giới từ chỉ chuyển động từ bên này sang bên kia.' },
  { sentence: 'The dog ran towards its owner.', word: 'towards', pos: 'preposition', hint: 'giới từ chỉ hướng di chuyển, đứng trước danh từ "its owner".' },
  { sentence: 'The ladder is leaning against the tree.', word: 'against', pos: 'preposition', hint: 'giới từ chỉ vị trí tựa vào, đứng trước danh từ "the tree".' },
  { sentence: 'The farm is beyond the hill.', word: 'beyond', pos: 'preposition', hint: 'giới từ chỉ vị trí xa hơn, đứng trước danh từ "the hill".' },
  { sentence: 'The toys are inside the box.', word: 'inside', pos: 'preposition', hint: 'giới từ chỉ vị trí bên trong, đứng trước danh từ "the box".' },
  { sentence: 'The children played outside the house.', word: 'outside', pos: 'preposition', hint: 'giới từ chỉ vị trí bên ngoài, đứng trước danh từ "the house".' },
  { sentence: 'She has lived here since 2010.', word: 'since', pos: 'preposition', hint: 'giới từ chỉ mốc thời gian bắt đầu, đứng trước "2010".' },
  { sentence: 'They went out despite the rain.', word: 'despite', pos: 'preposition', hint: 'giới từ chỉ sự tương phản, đứng trước danh từ "the rain".' },
  { sentence: 'She won first prize at the fair.', word: 'She', pos: 'pronoun', hint: 'đại từ nhân xưng ngôi 3 số ít, thay cho tên riêng nữ đã nhắc.' },
  { sentence: 'They are playing in the yard.', word: 'They', pos: 'pronoun', hint: 'đại từ nhân xưng ngôi 3 số nhiều, thay cho danh từ số nhiều đã nhắc.' },
  { sentence: 'This looks like the right answer.', word: 'This', pos: 'pronoun', hint: 'đại từ chỉ định, thay cho vật ở gần đã nhắc.' },
  { sentence: 'Those are my new shoes.', word: 'Those', pos: 'pronoun', hint: 'đại từ chỉ định số nhiều, thay cho vật ở xa đã nhắc.' },
  { sentence: 'Who left this note on my desk?', word: 'Who', pos: 'pronoun', hint: 'đại từ nghi vấn, dùng để hỏi về người.' },
  { sentence: 'This umbrella is mine.', word: 'mine', pos: 'pronoun', hint: 'đại từ sở hữu, thay cho "my umbrella".' },
  { sentence: 'I fixed the bicycle myself.', word: 'myself', pos: 'pronoun', hint: 'đại từ phản thân, nhấn mạnh chủ ngữ tự làm hành động.' },
  { sentence: 'Everyone enjoyed the show.', word: 'Everyone', pos: 'pronoun', hint: 'đại từ bất định, chỉ tất cả mọi người.' },
  { sentence: 'Nobody answered the phone.', word: 'Nobody', pos: 'pronoun', hint: 'đại từ bất định, chỉ không một ai.' },
  { sentence: 'I heard something strange.', word: 'something', pos: 'pronoun', hint: 'đại từ bất định, chỉ một vật không xác định.' },
  { sentence: 'The twins always help each other.', word: 'each other', pos: 'pronoun', hint: 'đại từ tương hỗ, chỉ hành động qua lại giữa 2 người.' },
  { sentence: 'Whose turn is it to clean the room?', word: 'Whose', pos: 'pronoun', hint: 'đại từ nghi vấn sở hữu, dùng để hỏi vật thuộc về ai.' },
  { sentence: 'None of the answers were correct.', word: 'None', pos: 'pronoun', hint: 'đại từ bất định, chỉ số lượng "không cái nào".' },
  { sentence: 'Both of the puppies fell asleep.', word: 'Both', pos: 'pronoun', hint: 'đại từ chỉ số lượng, nghĩa "cả hai".' },
  { sentence: 'Did you bring anything to eat?', word: 'anything', pos: 'pronoun', hint: 'đại từ bất định, dùng trong câu hỏi/phủ định.' },
  { sentence: 'The cat washed itself in the sun.', word: 'itself', pos: 'pronoun', hint: 'đại từ phản thân, dùng cho vật ở ngôi thứ 3 số ít.' },
  { sentence: 'We fixed the fence ourselves.', word: 'ourselves', pos: 'pronoun', hint: 'đại từ phản thân, dùng cho chủ ngữ "we".' },
  { sentence: 'Which one do you prefer?', word: 'Which', pos: 'pronoun', hint: 'đại từ nghi vấn, dùng để hỏi lựa chọn giữa các vật.' },
  { sentence: 'Someone forgot their jacket in the hall.', word: 'Someone', pos: 'pronoun', hint: 'đại từ bất định, chỉ một người không xác định.' },
  { sentence: 'I bought apples and oranges.', word: 'and', pos: 'conjunction', hint: 'liên từ kết hợp, nối 2 danh từ cùng chức năng.' },
  { sentence: 'She is small but very strong.', word: 'but', pos: 'conjunction', hint: 'liên từ tương phản, nối 2 ý đối lập.' },
  { sentence: 'Do you want tea or coffee?', word: 'or', pos: 'conjunction', hint: 'liên từ lựa chọn, nối 2 phương án.' },
  { sentence: 'She was late because the bus broke down.', word: 'because', pos: 'conjunction', hint: 'liên từ chỉ nguyên nhân, nối lý do vào câu.' },
  { sentence: 'Although it was raining, they went out.', word: 'Although', pos: 'conjunction', hint: 'liên từ nhượng bộ, nối 2 mệnh đề đối lập.' },
  { sentence: 'She read a book while waiting.', word: 'while', pos: 'conjunction', hint: 'liên từ chỉ đồng thời, nối 2 hành động cùng lúc.' },
  { sentence: 'It was late, so we went home.', word: 'so', pos: 'conjunction', hint: 'liên từ chỉ kết quả, nối nguyên nhân với kết quả.' },
  { sentence: 'We will not leave unless it stops raining.', word: 'unless', pos: 'conjunction', hint: 'liên từ điều kiện phủ định, nghĩa "trừ khi".' },
  { sentence: "Since you are here, let's start.", word: 'Since', pos: 'conjunction', hint: 'liên từ chỉ lý do, nghĩa "vì/bởi vì".' },
  { sentence: 'If it rains, we will stay inside.', word: 'If', pos: 'conjunction', hint: 'liên từ điều kiện, nối mệnh đề điều kiện với kết quả.' },
  { sentence: 'Call me when you arrive.', word: 'when', pos: 'conjunction', hint: 'liên từ chỉ thời gian, nối 2 mệnh đề theo thời điểm.' },
  { sentence: 'We left as soon as the bell rang.', word: 'as soon as', pos: 'conjunction', hint: 'liên từ chỉ thời gian, nghĩa "ngay khi".' },
  { sentence: 'He likes tea, whereas she prefers coffee.', word: 'whereas', pos: 'conjunction', hint: 'liên từ tương phản, nối 2 ý khác biệt.' },
  { sentence: 'Even though it was expensive, she bought the ticket.', word: 'Even though', pos: 'conjunction', hint: 'liên từ nhượng bộ, nghĩa "mặc dù".' },
  { sentence: 'The plan was risky, yet it worked.', word: 'yet', pos: 'conjunction', hint: 'liên từ tương phản, nghĩa "nhưng vẫn".' },
  { sentence: "She doesn't sing, nor does she dance.", word: 'nor', pos: 'conjunction', hint: 'liên từ phủ định nối tiếp, dùng sau mệnh đề phủ định.' },
  { sentence: 'You may go out, provided that you finish your homework.', word: 'provided that', pos: 'conjunction', hint: 'liên từ điều kiện, nghĩa "miễn là".' },
  { sentence: 'Once you learn to ride a bike, you never forget.', word: 'Once', pos: 'conjunction', hint: 'liên từ chỉ thời gian, nghĩa "một khi".' },
  { sentence: 'It was cold, though the sun was shining.', word: 'though', pos: 'conjunction', hint: 'liên từ tương phản, nghĩa "mặc dù".' },
  { sentence: 'Wow! That trick was amazing!', word: 'Wow', pos: 'interjection', hint: 'thán từ thể hiện sự ngạc nhiên/thán phục.' },
  { sentence: 'Ouch! That really hurt!', word: 'Ouch', pos: 'interjection', hint: 'thán từ thể hiện đau đớn.' },
  { sentence: 'Hooray! The rain finally stopped!', word: 'Hooray', pos: 'interjection', hint: 'thán từ thể hiện vui mừng, chiến thắng.' },
  { sentence: 'Oh no! I forgot my homework!', word: 'Oh no', pos: 'interjection', hint: 'thán từ thể hiện sự lo lắng/thất vọng bất ngờ.' },
  { sentence: 'Yikes! That spider is huge!', word: 'Yikes', pos: 'interjection', hint: 'thán từ thể hiện sự sợ hãi/giật mình.' },
  { sentence: 'Bravo! You solved the whole puzzle!', word: 'Bravo', pos: 'interjection', hint: 'thán từ thể hiện sự khen ngợi.' },
  { sentence: 'Phew! We made it just in time.', word: 'Phew', pos: 'interjection', hint: 'thán từ thể hiện sự nhẹ nhõm.' },
  { sentence: 'Ugh! This soup is too salty.', word: 'Ugh', pos: 'interjection', hint: 'thán từ thể hiện sự khó chịu.' },
  { sentence: 'Shh! Someone is trying to study.', word: 'Shh', pos: 'interjection', hint: 'thán từ yêu cầu giữ im lặng.' },
  { sentence: "Hurray! It's finally the weekend!", word: 'Hurray', pos: 'interjection', hint: 'thán từ thể hiện vui mừng.' },
  { sentence: 'Alas! The kite flew away.', word: 'Alas', pos: 'interjection', hint: 'thán từ thể hiện sự tiếc nuối/buồn bã.' },
  { sentence: "Gosh! I can't believe how tall you've grown!", word: 'Gosh', pos: 'interjection', hint: 'thán từ thể hiện sự ngạc nhiên nhẹ.' },
  { sentence: "Yippee! School is out for summer!", word: 'Yippee', pos: 'interjection', hint: 'thán từ thể hiện sự phấn khích.' },
  { sentence: 'Aha! I found the missing piece!', word: 'Aha', pos: 'interjection', hint: 'thán từ thể hiện sự phát hiện ra điều gì đó.' },
  { sentence: "Yuck! I don't like broccoli.", word: 'Yuck', pos: 'interjection', hint: 'thán từ thể hiện sự ghê tởm/không thích.' },
  { sentence: 'Whoa! Slow down on the bike!', word: 'Whoa', pos: 'interjection', hint: 'thán từ thể hiện sự bất ngờ/cảnh báo.' },
  { sentence: 'Aww! The puppy is so cute!', word: 'Aww', pos: 'interjection', hint: 'thán từ thể hiện sự yêu thích/cảm động.' },
  { sentence: 'Oops! I dropped my ice cream.', word: 'Oops', pos: 'interjection', hint: 'thán từ thể hiện sự lỡ tay/vô ý.' },
  { sentence: 'Hey! Wait for me!', word: 'Hey', pos: 'interjection', hint: 'thán từ dùng để gọi hoặc thu hút sự chú ý.' },
];
