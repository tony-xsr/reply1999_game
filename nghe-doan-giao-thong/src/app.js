// Điều phối Nghe & Đoán: Giao Thông & Địa Lý — máy đọc 1 từ hoặc câu tiếng Anh ngắn
// (giọng en-US thật, câu dài đọc chậm hơn), bé chạm đúng hình phù hợp trong 4 lựa
// chọn — lọc được theo chủ đề (phương tiện / tiện ích công cộng / môi trường /
// đô thị & thôn quê / địa lý & địa hình) hoặc chơi lẫn cả 5 chủ đề ("Tất cả").
...
sayInstruction(t('nghedoan2.help', 'Máy sẽ đọc một từ hoặc câu tiếng Anh ngắn về giao thông, môi trường hay địa lý — bé nghe thật kỹ rồi chạm vào hình đúng trong 4 hình bên dưới nhé! Chọn đúng liên tiếp 3 lần sẽ được điểm thưởng đó. Có thể lọc theo chủ đề ở hàng nút trên cùng.'));
startRound();

// Hook cho e2e test
window.__nghedoan2 = { state, startRound };
